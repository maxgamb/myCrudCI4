 ...
 */
final class AddressRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'CityService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = AddressRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/AddressController.php';
        $modelPath = APPPATH . 'Models/AddressModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/AddressService.php';
            ...
            self::assertStringContainsString('AddressRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = AddressRules::manyToManyRelatedCreateRules();
