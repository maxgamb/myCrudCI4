 ...
 */
final class InventoryRelationalContractTest extends CIUnitTestCase
{
  ...
  1 => 'StoreService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = InventoryRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/InventoryController.php';
        $modelPath = APPPATH . 'Models/InventoryModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/InventoryService.php';
            ...
            self::assertStringContainsString('InventoryRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = InventoryRules::manyToManyRelatedCreateRules();
