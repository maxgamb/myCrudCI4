...
final class InventoryMcpResourceSecurityContractTest extends CIUnitTestCase
{
  ...
  3 => 'last_update',
    ...
    public function testMcpResourceExposesOnlyMcpVisibleFields(): void
    {
        ...
        $result = InventoryMcpResource::make($source);
    ...
    {
        $path = APPPATH . 'Mcp/Resources/InventoryMcpResource.php';
