# NicerButSlowerFilmList generated tests

Generated by myCrudCI4 for table `nicer_but_slower_film_list` using **full** architecture.
...
```text
tests/Generated/MyCrud/NicerButSlowerFilmList/
```
