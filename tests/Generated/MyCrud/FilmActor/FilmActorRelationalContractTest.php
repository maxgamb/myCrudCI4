 ...
 */
final class FilmActorRelationalContractTest extends CIUnitTestCase
{
  ...
  1 => 'FilmService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = FilmActorRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/FilmActorController.php';
        $modelPath = APPPATH . 'Models/FilmActorModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/FilmActorService.php';
            ...
            self::assertStringContainsString('FilmActorRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = FilmActorRules::manyToManyRelatedCreateRules();
