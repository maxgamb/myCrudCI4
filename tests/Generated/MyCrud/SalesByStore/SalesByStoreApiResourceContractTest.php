 ...
 */
final class SalesByStoreApiResourceContractTest extends CIUnitTestCase
{
  ...
  2 => 'total_sales',
    ...
    public function testResourceMakeExposesOnlyReadableFields(): void
    {
        ...
        $result = SalesByStoreResource::make($source);
    ...
    {
        $path = APPPATH . 'API/Resources/SalesByStoreResource.php';
