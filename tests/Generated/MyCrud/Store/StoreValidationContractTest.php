 ...
 */
final class StoreValidationContractTest extends CIUnitTestCase
{
  ...
  1 => 'last_update',
    ...
    {
        $rules = StoreRules::updateRules('1');
        $this->assertIsArray($rules);
    ...
    {
        $this->assertIsArray(StoreRules::messages());
    }
}
