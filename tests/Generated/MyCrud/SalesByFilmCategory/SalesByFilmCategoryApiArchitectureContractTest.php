...
final class SalesByFilmCategoryApiArchitectureContractTest extends CIUnitTestCase
{
    public function testApiControllerUsesModelForReadsAndServiceForWritesWithoutSql(): void
    {
        $path = APPPATH . 'Controllers/Api/V1/SalesByFilmCategoryApiController.php';
        $this->assertFileExists($path);
        $php = (string) file_get_contents($path);

        $this->assertStringContainsString('private readonly SalesByFilmCategoryModel $model', $php);
    ...
    {
        $resource = (string) file_get_contents(APPPATH . 'API/Resources/SalesByFilmCategoryResource.php');
