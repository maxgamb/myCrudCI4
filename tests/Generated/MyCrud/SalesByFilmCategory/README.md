# SalesByFilmCategory generated tests

Generated by myCrudCI4 for table `sales_by_film_category` using **full** architecture.
...
```text
tests/Generated/MyCrud/SalesByFilmCategory/
```
