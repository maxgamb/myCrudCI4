 ...
 */
final class CustomerListOpenApiContractTest extends CIUnitTestCase
{
  ...
  0 => 'listCustomerList',
    ...
    {
        $path = APPPATH . 'OpenApi/customer_list.yaml';

        $this->assertFileExists($path);

        $yaml = (string) file_get_contents($path);
        $this->assertStringContainsString('openapi: 3.0.3', $yaml);
        $this->assertStringContainsString('/api/v1/customer_list', $yaml);
