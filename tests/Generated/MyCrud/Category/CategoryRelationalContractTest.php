 ...
 */
final class CategoryRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'FilmService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = CategoryRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/CategoryController.php';
        $modelPath = APPPATH . 'Models/CategoryModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/CategoryService.php';
            ...
            self::assertStringContainsString('CategoryRules::createRules()', $service);
