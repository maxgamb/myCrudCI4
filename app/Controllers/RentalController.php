...
/**
 * Controller CRUD full per rental.
 *
...
final class RentalController extends BaseController
{
  ...
  array (
    ...
    {
        helper(['form', 'url']);
        $this->gateway = new RentalService();
  ...
  2 => 'staff_id',
    ...
    public function store()
    {
        ...
        return redirect()->to($this->contextUrl('rental', $navigationContext))->with('message', 'Record creato correttamente.');
    }
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('rental', $navigationContext))->with('message', 'Record aggiornato correttamente.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('rental', $navigationContext))->with('message', 'Record eliminato correttamente.');
    }
    /**
