...
/**
 * Controller CRUD full per inventory.
 *
...
final class InventoryController extends BaseController
{
  ...
  array (
    ...
    {
        helper(['form', 'url']);
        $this->gateway = new InventoryService();
  ...
  1 => 'store_id',
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('inventory', $navigationContext))->with('message', 'Record aggiornato correttamente.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('inventory', $navigationContext))->with('message', 'Record eliminato correttamente.');
    }
    /**
