...
/**
 * Controller CRUD full per foglio_giorno.
 *
...
final class FoglioGiornoController extends BaseController
{
    ...
    private FoglioGiornoService $gateway;
    ...
    {
        helper(['form', 'url']);
        $this->gateway = new FoglioGiornoService();
  ...
  2 => 100,
    ...
    private function export(string $format)
    {
        ...
        $listRequest = CrudListRequest::fromRequest($this->request, 'foglio_id', array (
  0 => 25,
  1 => 50,
  2 => 100,
));
        ...
        try {
            return $this->exporter->download(
                ...
                filename: 'foglio_giorno',
                languageGroup: 'FoglioGiorno',
