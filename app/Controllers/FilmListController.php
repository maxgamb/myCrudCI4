...
use App\Validation\FilmListRules;
use CodeIgniter\Exceptions\PageNotFoundException;
use RuntimeException;
use Throwable;

/**
 * Controller CRUD full per film_list.
 *
...
final class FilmListController extends BaseController
{
    ...
    private FilmListService $gateway;
    ...
    {
        helper(['form', 'url']);
        $this->gateway = new FilmListService();
  ...
  2 => 100,
    ...
    private function validateRelatedCreates(array $related): array
    {
        ...
        $definitions = FilmListRules::relatedCreateRules();
        $errors = [];
