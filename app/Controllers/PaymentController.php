...
/**
 * Controller CRUD full per payment.
 *
...
final class PaymentController extends BaseController
{
  ...
  array (
    ...
    {
        helper(['form', 'url']);
        $this->gateway = new PaymentService();
  ...
  2 => 'rental_id',
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('payment', $navigationContext))->with('message', 'Record aggiornato correttamente.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('payment', $navigationContext))->with('message', 'Record eliminato correttamente.');
    }
    /**
