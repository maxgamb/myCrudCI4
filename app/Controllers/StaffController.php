...
final class StaffController extends BaseController
{
  ...
  2 => 100,
    ...
    public function store()
    {
        ...
        if (!$this->validate(StaffRules::createRules(), StaffRules::messages())) {
        ...
        return redirect()->to(site_url('staff'))->with('message', 'Record creato correttamente.');
    }
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to(site_url('staff'))->with('message', 'Record aggiornato correttamente.');
    }
    ...
    public function delete(int|string $id)
    {
        try {
            ...
            return redirect()->to(site_url('staff'))->with('error', $e->getMessage());
        }

        return redirect()->to(site_url('staff'))->with('message', 'Record eliminato correttamente.');
    }
  ...
  2 => 100,
    ...
    {
        return redirect()->to(site_url('staff') . '?' . http_build_query((array) $this->request->getGet()))
