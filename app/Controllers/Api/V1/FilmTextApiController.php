...
/**
 * REST API v1 for resource `film_text`.
...
final class FilmTextApiController extends BaseApiController
{
  ...
  2 => 'description',
    ...
    public function __construct(
        private readonly FilmTextModel $model = new FilmTextModel(),
        private readonly FilmTextService $service = new FilmTextService()
    ) {
    }
    ...
    {
        try {
            return $this->success(FilmTextResource::make($this->recordOrFail($id)));
