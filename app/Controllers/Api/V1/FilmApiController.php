...
/** API REST v1 per la risorsa film. */
final class FilmApiController extends BaseApiController
{
    public function __construct(private readonly FilmService $service = new FilmService())
    {
    }
    ...
    public function index()
    {
        try {
            ...
            $result = $this->service->apiList($query, FilmResource::filterableFields(), FilmResource::sortableFields());
    ...
    {
        try {
            return $this->success(FilmResource::make($this->service->find($id)));
    ...
    {
        $data = FilmResource::writableData($this->payload());
        if ($data === []) {
