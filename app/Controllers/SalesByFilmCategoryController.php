...
use App\Validation\SalesByFilmCategoryRules;
use CodeIgniter\Exceptions\PageNotFoundException;
use RuntimeException;
use Throwable;

/**
 * Controller CRUD full per sales_by_film_category.
 *
...
final class SalesByFilmCategoryController extends BaseController
{
    ...
    {
        helper(['form', 'url']);
        $this->gateway = new SalesByFilmCategoryService();
  ...
  2 => 100,
    ...
    private function export(string $format)
    {
        ...
        $listRequest = CrudListRequest::fromRequest($this->request, 'category', array (
  0 => 25,
  1 => 50,
  2 => 100,
), array (
    ...
    private function validateRelatedCreates(array $related): array
    {
        ...
        $definitions = SalesByFilmCategoryRules::relatedCreateRules();
        $errors = [];
