...
/**
 * CRUD full controller for resource `category`.
 *
...
final class CategoryController extends BaseController
{
  ...
  0 => 'category_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('category', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('category', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('category', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
  ...
  0 => 'last_update',
    ...
    private function validateManyToManyRelatedCreates(array $payloads): array
    {
        ...
        $definitions = CategoryRules::manyToManyRelatedCreateRules();
        $errors = [];
