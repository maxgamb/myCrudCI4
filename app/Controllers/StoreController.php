...
/**
 * CRUD full controller for resource `store`.
 *
...
final class StoreController extends BaseController
{
  ...
  0 => 'manager_staff_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('store', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('store', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('store', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
