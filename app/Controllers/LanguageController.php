...
/**
 * CRUD full controller for resource `language`.
 *
...
final class LanguageController extends BaseController
{
  ...
  0 => 'language_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('language', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('language', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('language', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
