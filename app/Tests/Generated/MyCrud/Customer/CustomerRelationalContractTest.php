 ...
 */
final class CustomerRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'payment__customer_id',
  1 => 'rental__customer_id',
);
  ...
  1 => 'AddressService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = CustomerRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/CustomerController.php';
        $modelPath = APPPATH . 'Models/CustomerModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/CustomerService.php';
            ...
            self::assertStringContainsString('CustomerRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = CustomerRules::manyToManyRelatedCreateRules();
