...
final class FilmListApiArchitectureContractTest extends CIUnitTestCase
{
    public function testApiControllerUsesModelForReadsAndServiceForWritesWithoutSql(): void
    {
        $path = APPPATH . 'Controllers/Api/V1/FilmListApiController.php';
        $this->assertFileExists($path);
        $php = (string) file_get_contents($path);

        $this->assertStringContainsString('private readonly FilmListModel $model', $php);
    ...
    {
        $resource = (string) file_get_contents(APPPATH . 'API/Resources/FilmListResource.php');
