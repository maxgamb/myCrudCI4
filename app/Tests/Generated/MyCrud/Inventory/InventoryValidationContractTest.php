 ...
 */
final class InventoryValidationContractTest extends CIUnitTestCase
{
  ...
  1 => 'last_update',
    ...
    {
        $rules = InventoryRules::createRules();
    ...
    {
        $rules = InventoryRules::updateRules('1');
        $this->assertIsArray($rules);
    ...
    {
        $this->assertIsArray(InventoryRules::messages());
    }
}
