 ...
 */
final class StaffListApiResourceContractTest extends CIUnitTestCase
{
  ...
  7 => 'SID',
    ...
    public function testResourceMakeExposesOnlyReadableFields(): void
    {
        ...
        $result = StaffListResource::make($source);
    ...
    {
        $path = APPPATH . 'API/Resources/StaffListResource.php';
