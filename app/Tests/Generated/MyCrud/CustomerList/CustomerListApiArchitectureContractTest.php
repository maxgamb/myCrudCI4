...
final class CustomerListApiArchitectureContractTest extends CIUnitTestCase
{
    public function testApiControllerUsesModelForReadsAndServiceForWritesWithoutSql(): void
    {
        $path = APPPATH . 'Controllers/Api/V1/CustomerListApiController.php';
        $this->assertFileExists($path);
        $php = (string) file_get_contents($path);

        $this->assertStringContainsString('private readonly CustomerListModel $model', $php);
    ...
    {
        $resource = (string) file_get_contents(APPPATH . 'API/Resources/CustomerListResource.php');
