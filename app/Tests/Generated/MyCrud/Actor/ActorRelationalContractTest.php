 ...
 */
final class ActorRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'FilmService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = ActorRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/ActorController.php';
        $modelPath = APPPATH . 'Models/ActorModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/ActorService.php';
            ...
            self::assertStringContainsString('ActorRules::createRules()', $service);
