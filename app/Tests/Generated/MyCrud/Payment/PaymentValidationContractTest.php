 ...
 */
final class PaymentValidationContractTest extends CIUnitTestCase
{
  ...
  1 => 'last_update',
    ...
    {
        $rules = PaymentRules::createRules();
    ...
    {
        $rules = PaymentRules::updateRules('1');
        $this->assertIsArray($rules);
    ...
    {
        $this->assertIsArray(PaymentRules::messages());
    }
}
