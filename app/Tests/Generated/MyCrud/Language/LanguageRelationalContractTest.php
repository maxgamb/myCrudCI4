 ...
 */
final class LanguageRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'FilmModel',
    ...
    private const EXPECTS_SERVICE_RELATED_TRANSACTION = false;
    private const SERVICE_ENABLED = true;
    private const EXPECTS_UNIQUE_NESTED_FK_FILTER = false;
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = LanguageRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/LanguageController.php';
        $modelPath = APPPATH . 'Models/LanguageModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/LanguageService.php';
            ...
            self::assertStringContainsString('LanguageRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = LanguageRules::manyToManyRelatedCreateRules();
