 ...
 */
final class CityRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'CountryService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = CityRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/CityController.php';
        $modelPath = APPPATH . 'Models/CityModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/CityService.php';
            ...
            self::assertStringContainsString('CityRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = CityRules::manyToManyRelatedCreateRules();
