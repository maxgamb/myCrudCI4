...
/**
 * Read-only Model for SQL VIEW `sales_by_film_category`. Centralizes read queries, filters, and export.
 *
 ...
 */
final class SalesByFilmCategoryModel extends BaseCrudModel
{
