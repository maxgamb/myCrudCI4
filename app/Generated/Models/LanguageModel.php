...
/**
 * Model for `language`. Centralizes CRUD queries, filters, relations, and persistence.
 *
 ...
 */
final class LanguageModel extends BaseCrudModel
{
  ...
  2 => 'last_update',
    ...
    /**
     * HasMany scaffolding delegated to the Model that owns table film.
    ...
    {
        return (new FilmModel())->childrenByForeignKey(
            'language_id',
            $parentId,
            array (
  0 => 'film_id',
