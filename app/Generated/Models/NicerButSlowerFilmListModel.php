...
/** Model read-only per SQL VIEW nicer_but_slower_film_list; estendere manualmente solo se necessario. */
final class NicerButSlowerFilmListModel extends Model
{
  ...
  7 => 'actors',
    ...
    public function getDetail(int|string $id): ?object
    {
        return $this->baseBuilder()
            ->where('nicer_but_slower_film_list.FID', $id)
            ->get()
            ->getRow();
    }
    ...
    private function applyListFilters(BaseBuilder $builder, array $filters, bool $qualified): void
    {
        ...
        foreach (array_values($filters) as $filter) {
            ...
            $column = $qualified ? 'nicer_but_slower_film_list.' . $field : $field;
