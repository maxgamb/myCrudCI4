...
/** Model per film_text; tutte le query del CRUD sono centralizzate qui. */
final class FilmTextModel extends Model
{
  ...
  0 => 'film_id',
    ...
    private function applyListFilters(BaseBuilder $builder, array $filters, bool $qualified): void
    {
        ...
        foreach (array_values($filters) as $filter) {
            ...
            $column = $qualified ? 'film_text.' . $field : $field;
