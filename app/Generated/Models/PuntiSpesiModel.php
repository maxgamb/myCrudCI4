  ...
  array (
    ...
    public function baseBuilder(): BaseBuilder
    {
        ...
        $builder->select([
            ...
            'clienti__cliente_id.camara_tipologia AS clienti_camara_tipologia',
    ...
    public function getClientiClienteIdOptions(): array
    {
        return $this->db->table('clienti')
            ->select(['clienti_id', 'camara_tipologia'])
    ...
    {
        return [
            'cliente_id' => $this->toOptions($this->getClientiClienteIdOptions(), 'clienti_id', 'camara_tipologia'),
