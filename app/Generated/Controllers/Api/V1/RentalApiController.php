...
/**
 * REST API v1 for resource `rental`.
...
final class RentalApiController extends BaseApiController
{
  ...
  4 => 'staff_id',
    ...
    public function __construct(
        private readonly RentalModel $model = new RentalModel(),
        private readonly RentalService $service = new RentalService()
    ) {
    }
    ...
    {
        try {
            return $this->success(RentalResource::make($this->recordOrFail($id)));
