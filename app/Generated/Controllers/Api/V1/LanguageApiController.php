...
/**
 * REST API v1 for resource `language`.
...
final class LanguageApiController extends BaseApiController
{
  ...
  0 => 'name',
    ...
    public function __construct(
        private readonly LanguageModel $model = new LanguageModel(),
        private readonly LanguageService $service = new LanguageService()
    ) {
    }
    ...
    {
        try {
            return $this->success(LanguageResource::make($this->recordOrFail($id)));
