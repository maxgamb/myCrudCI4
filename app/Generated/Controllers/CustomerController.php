...
/**
 * CRUD full controller for resource `customer`.
 *
...
final class CustomerController extends BaseController
{
  ...
  1 => 'address_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('customer', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('customer', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('customer', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
