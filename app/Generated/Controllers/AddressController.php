...
/**
 * CRUD full controller for resource `address`.
 *
...
final class AddressController extends BaseController
{
  ...
  0 => 'city_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('address', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('address', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('address', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
