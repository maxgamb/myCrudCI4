...
/**
 * CRUD full controller for resource `country`.
 *
...
final class CountryController extends BaseController
{
  ...
  0 => 'country_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('country', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('country', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('country', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
