...
/**
 * CRUD full controller for resource `staff`.
 *
...
final class StaffController extends BaseController
{
  ...
  0 => 'store_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('staff', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('staff', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('staff', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
