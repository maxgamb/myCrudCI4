...
/**
 * CRUD full controller for resource `city`.
 *
...
final class CityController extends BaseController
{
  ...
  0 => 'country_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('city', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('city', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('city', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
