...
/**
 * Read/create controller for `film_actor`.
 *
...
final class FilmActorController extends BaseController
{
  ...
  array (
    ...
    {
        helper(['form', 'url']);
        $this->model = new FilmActorModel();
        $this->service = new FilmActorService();
  ...
  1 => 'film_id',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('film_actor', $navigationContext, $cascadeTrail);
