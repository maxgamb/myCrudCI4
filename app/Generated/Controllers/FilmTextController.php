...
/**
 * CRUD full controller for resource `film_text`.
 *
...
final class FilmTextController extends BaseController
{
    ...
    {
        helper(['form', 'url']);
        $this->model = new FilmTextModel();
        $this->service = new FilmTextService();
  ...
  1 => 'title',
    ...
    public function store()
    {
        ...
        $redirectUrl = $parentContext['url'] ?? $this->contextUrl('film_text', $navigationContext, $cascadeTrail);
    ...
    public function update(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('film_text', $navigationContext, $cascadeTrail))->with('message', 'Record updated successfully.');
    }
    ...
    public function delete(int|string $id)
    {
        ...
        return redirect()->to($this->contextUrl('film_text', $navigationContext))->with('message', 'Record deleted successfully.');
    }
    /**
