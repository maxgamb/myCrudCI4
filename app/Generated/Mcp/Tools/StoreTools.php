...
/**
 * MCP tools generated by myCrudCI4 for store.
 *
...
final class StoreTools
{
  ...
  2 => 'address_id',
    ...
    /**
     * Returns a paginated read-only list of store records.
     *
    ...
    public function listStore(
        ...
        return [
            'data' => StoreMcpResource::collection($result['rows']),
            'meta' => $result['meta'],
            'links' => $result['links'],
        ];
    }
    ...
    /**
     * Returns the read-only details of a store record.
     *
    ...
    public function getStore(string $id): array
    {
        ...
        return StoreMcpResource::make($record);
    }
}
