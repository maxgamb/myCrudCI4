 ...
 */
final class FilmCategoryRelationalContractTest extends CIUnitTestCase
{
  ...
  1 => 'CategoryService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = FilmCategoryRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/FilmCategoryController.php';
        $modelPath = APPPATH . 'Models/FilmCategoryModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/FilmCategoryService.php';
            ...
            self::assertStringContainsString('FilmCategoryRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = FilmCategoryRules::manyToManyRelatedCreateRules();
