 ...
 */
final class StaffListOpenApiContractTest extends CIUnitTestCase
{
  ...
  0 => 'listStaffList',
    ...
    {
        $path = APPPATH . 'OpenApi/staff_list.yaml';

        $this->assertFileExists($path);

        $yaml = (string) file_get_contents($path);
        $this->assertStringContainsString('openapi: 3.0.3', $yaml);
        $this->assertStringContainsString('/api/v1/staff_list', $yaml);
