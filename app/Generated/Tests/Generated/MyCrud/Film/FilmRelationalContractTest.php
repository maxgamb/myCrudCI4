 ...
 */
final class FilmRelationalContractTest extends CIUnitTestCase
{
  ...
  1 => 'CategoryService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = FilmRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/FilmController.php';
        $modelPath = APPPATH . 'Models/FilmModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/FilmService.php';
            ...
            self::assertStringContainsString('FilmRules::createRules()', $service);
