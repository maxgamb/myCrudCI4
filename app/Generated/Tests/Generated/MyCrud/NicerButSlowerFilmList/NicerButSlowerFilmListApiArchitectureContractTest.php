...
final class NicerButSlowerFilmListApiArchitectureContractTest extends CIUnitTestCase
{
    public function testApiControllerUsesModelForReadsAndServiceForWritesWithoutSql(): void
    {
        $path = APPPATH . 'Controllers/Api/V1/NicerButSlowerFilmListApiController.php';
        $this->assertFileExists($path);
        $php = (string) file_get_contents($path);

        $this->assertStringContainsString('private readonly NicerButSlowerFilmListModel $model', $php);
    ...
    {
        $resource = (string) file_get_contents(APPPATH . 'API/Resources/NicerButSlowerFilmListResource.php');
