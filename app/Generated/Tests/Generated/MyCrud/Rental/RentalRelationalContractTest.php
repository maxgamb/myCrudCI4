 ...
 */
final class RentalRelationalContractTest extends CIUnitTestCase
{
  ...
  2 => 'StaffService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = RentalRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/RentalController.php';
        $modelPath = APPPATH . 'Models/RentalModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/RentalService.php';
            ...
            self::assertStringContainsString('RentalRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = RentalRules::manyToManyRelatedCreateRules();
