 ...
 */
final class StoreRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'customer__store_id',
  1 => 'inventory__store_id',
  2 => 'staff__store_id',
);
  ...
  1 => 'AddressService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = StoreRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/StoreController.php';
        $modelPath = APPPATH . 'Models/StoreModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/StoreService.php';
            ...
            self::assertStringContainsString('StoreRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = StoreRules::manyToManyRelatedCreateRules();
