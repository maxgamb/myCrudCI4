 ...
 */
final class SalesByStoreOpenApiContractTest extends CIUnitTestCase
{
  ...
  0 => 'listSalesByStore',
    ...
    {
        $path = APPPATH . 'OpenApi/sales_by_store.yaml';

        $this->assertFileExists($path);

        $yaml = (string) file_get_contents($path);
        $this->assertStringContainsString('openapi: 3.0.3', $yaml);
        $this->assertStringContainsString('/api/v1/sales_by_store', $yaml);
