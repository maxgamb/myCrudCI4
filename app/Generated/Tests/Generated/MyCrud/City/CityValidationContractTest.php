 ...
 */
final class CityValidationContractTest extends CIUnitTestCase
{
  ...
  1 => 'last_update',
    ...
    {
        $this->assertIsArray(CityRules::messages());
    }
}
