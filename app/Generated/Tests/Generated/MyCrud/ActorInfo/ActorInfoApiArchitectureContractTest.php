...
final class ActorInfoApiArchitectureContractTest extends CIUnitTestCase
{
    public function testApiControllerUsesModelForReadsAndServiceForWritesWithoutSql(): void
    {
        $path = APPPATH . 'Controllers/Api/V1/ActorInfoApiController.php';
        $this->assertFileExists($path);
        $php = (string) file_get_contents($path);

        $this->assertStringContainsString('private readonly ActorInfoModel $model', $php);
    ...
    {
        $resource = (string) file_get_contents(APPPATH . 'API/Resources/ActorInfoResource.php');
