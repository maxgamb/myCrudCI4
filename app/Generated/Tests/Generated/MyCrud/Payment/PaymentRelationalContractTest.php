 ...
 */
final class PaymentRelationalContractTest extends CIUnitTestCase
{
  ...
  2 => 'RentalService',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = PaymentRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/PaymentController.php';
        $modelPath = APPPATH . 'Models/PaymentModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/PaymentService.php';
            ...
            self::assertStringContainsString('PaymentRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = PaymentRules::manyToManyRelatedCreateRules();
