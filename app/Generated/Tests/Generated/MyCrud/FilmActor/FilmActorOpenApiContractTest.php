 ...
 */
final class FilmActorOpenApiContractTest extends CIUnitTestCase
{
  ...
  1 => 'createFilmActor',
    ...
    {
        $path = APPPATH . 'OpenApi/film_actor.yaml';

        $this->assertFileExists($path);

        $yaml = (string) file_get_contents($path);
        $this->assertStringContainsString('openapi: 3.0.3', $yaml);
        $this->assertStringContainsString('/api/v1/film_actor', $yaml);
