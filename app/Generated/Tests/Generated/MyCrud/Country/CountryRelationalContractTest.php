 ...
 */
final class CountryRelationalContractTest extends CIUnitTestCase
{
  ...
  0 => 'CityModel',
    ...
    public function testRelatedCreateValidationMatchesConfiguredFields(): void
    {
        ...
        $rules = CountryRules::relatedCreateRules();
    ...
    public function testRelatedCreateControllerAndModelHooksArePresent(): void
    {
        ...
        $controllerPath = APPPATH . 'Controllers/CountryController.php';
        $modelPath = APPPATH . 'Models/CountryModel.php';
        ...
        if (self::SERVICE_ENABLED) {
            $servicePath = APPPATH . 'Services/CountryService.php';
            ...
            self::assertStringContainsString('CountryRules::createRules()', $service);
    ...
    public function testManyToManyContractsRemainGenerated(): void
    {
        ...
        if (self::MANY_TO_MANY_RELATED_CREATE_KEYS !== []) {
            $rules = CountryRules::manyToManyRelatedCreateRules();
