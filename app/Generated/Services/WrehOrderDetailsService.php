...
use App\Models\WrehOrderDetailsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class WrehOrderDetailsService
{
    ...
    public function __construct(private readonly WrehOrderDetailsModel $model = new WrehOrderDetailsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new WrehOrderDetailsEntity($data), true);
        if ($id === false) {
