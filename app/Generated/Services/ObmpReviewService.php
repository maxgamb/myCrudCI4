...
use App\Models\ObmpReviewModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpReviewService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'review_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly ObmpReviewModel $model = new ObmpReviewModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpReviewEntity($data), true);
        if ($id === false) {
