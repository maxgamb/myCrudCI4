...
final class CostiVarService
{
    ...
    public function __construct(private readonly CostiVarModel $model = new CostiVarModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new CostiVarEntity($data), true);
        if ($id === false) {
