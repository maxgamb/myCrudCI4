...
use App\Models\QuestionRewModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class QuestionRewService
{
    ...
    public function __construct(private readonly QuestionRewModel $model = new QuestionRewModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new QuestionRewEntity($data), true);
        if ($id === false) {
