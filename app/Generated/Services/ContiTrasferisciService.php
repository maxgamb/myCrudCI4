...
use App\Models\ContiTrasferisciModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ContiTrasferisciService
{
    ...
    public function __construct(private readonly ContiTrasferisciModel $model = new ContiTrasferisciModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ContiTrasferisciEntity($data), true);
        if ($id === false) {
