...
class CamereService
{
    private CamereModel $model;

    public function __construct(?CamereModel $model = null)
    {
        $this->model = $model ?? new CamereModel();
    }
    ...
    public function model(): CamereModel
    {
        return $this->model;
    }
}
