...
final class TexLingueService
{
    ...
    public function __construct(private readonly TexLingueModel $model = new TexLingueModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new TexLingueEntity($data), true);
        if ($id === false) {
