...
use App\Models\ObmpQuoteSubModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpQuoteSubService
{
    ...
    public function __construct(private readonly ObmpQuoteSubModel $model = new ObmpQuoteSubModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpQuoteSubEntity($data), true);
        if ($id === false) {
