...
final class PraticheService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'pratica_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly PraticheModel $model = new PraticheModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new PraticheEntity($data), true);
        if ($id === false) {
