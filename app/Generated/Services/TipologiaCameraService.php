...
use App\Models\{TipologiaCameraModel};
use RuntimeException;

class TipologiaCameraService
{
    private TipologiaCameraModel $model;

    public function __construct(?TipologiaCameraModel $model = null)
    {
        $this->model = $model ?? new TipologiaCameraModel();
    }
    ...
    {
        $record = new TipologiaCameraEntity($data);
    ...
    public function model(): TipologiaCameraModel
    {
        return $this->model;
    }
}
