...
final class ObmpRatesService
{
    ...
    public function __construct(private readonly ObmpRatesModel $model = new ObmpRatesModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpRatesEntity($data), true);
        if ($id === false) {
