...
final class TokenService
{
  ...
  'token_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly TokenModel $model = new TokenModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new TokenEntity($data), true);
        if ($id === false) {
