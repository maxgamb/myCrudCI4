...
use App\Models\AgenziaListiniModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class AgenziaListiniService
{
    ...
    public function __construct(private readonly AgenziaListiniModel $model = new AgenziaListiniModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new AgenziaListiniEntity($data), true);
        if ($id === false) {
