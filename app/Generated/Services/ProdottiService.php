...
final class ProdottiService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'prodotti_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly ProdottiModel $model = new ProdottiModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ProdottiEntity($data), true);
        if ($id === false) {
