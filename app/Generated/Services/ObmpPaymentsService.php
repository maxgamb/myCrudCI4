...
use App\Models\ObmpPaymentsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpPaymentsService
{
    ...
    public function __construct(private readonly ObmpPaymentsModel $model = new ObmpPaymentsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpPaymentsEntity($data), true);
        if ($id === false) {
