...
final class NicerButSlowerFilmListService
{
    ...
    public function __construct(private readonly NicerButSlowerFilmListModel $model = new NicerButSlowerFilmListModel())
    {
    }
