...
use App\Models\LogRichiesteModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class LogRichiesteService
{
    ...
    public function __construct(private readonly LogRichiesteModel $model = new LogRichiesteModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new LogRichiesteEntity($data), true);
        if ($id === false) {
