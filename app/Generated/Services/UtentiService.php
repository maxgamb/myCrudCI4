...
final class UtentiService
{
  ...
  'utenti_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly UtentiModel $model = new UtentiModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new UtentiEntity($data), true);
        if ($id === false) {
