...
use App\Models\ParsedEmailsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ParsedEmailsService
{
    ...
    public function __construct(private readonly ParsedEmailsModel $model = new ParsedEmailsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ParsedEmailsEntity($data), true);
        if ($id === false) {
