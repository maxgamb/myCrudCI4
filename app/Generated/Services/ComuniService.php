...
class ComuniService
{
    private ComuniModel $model;

    public function __construct(?ComuniModel $model = null)
    {
        $this->model = $model ?? new ComuniModel();
    }
    ...
    public function model(): ComuniModel
    {
        return $this->model;
    }
}
