...
use App\Models\RefAgendaClientiModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class RefAgendaClientiService
{
    ...
    public function __construct(private readonly RefAgendaClientiModel $model = new RefAgendaClientiModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new RefAgendaClientiEntity($data), true);
        if ($id === false) {
