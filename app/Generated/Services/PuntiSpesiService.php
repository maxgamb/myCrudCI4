...
use App\Models\PuntiSpesiModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class PuntiSpesiService
{
  ...
  'data_record' => 'Y-m-d H:i:s',
    ...
    public function __construct(private readonly PuntiSpesiModel $model = new PuntiSpesiModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new PuntiSpesiEntity($data), true);
        if ($id === false) {
