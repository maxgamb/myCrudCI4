...
$filterDefinitions = [
    'Comuni_Codice' => [
        'label' => lang('Comuni.Comuni_Codice'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('comuni') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'Comuni_Codice') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('comuni') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('comuni/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
