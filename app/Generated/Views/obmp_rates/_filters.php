...
$filterDefinitions = [
    'obmp_rate_id' => [
        'label' => lang('ObmpRates.obmp_rate_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_cm_rooms_id' => [
        'label' => lang('ObmpRates.obmp_cm_rooms_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_cm_rooms_id',
    ],
    'obmp_restriction_id' => [
        'label' => lang('ObmpRates.obmp_restriction_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_restriction_id',
    ],
    'obmp_board_cod' => [
        'label' => lang('ObmpRates.obmp_board_cod'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_board_cod',
    ],
    'obmp_cancellation_cod' => [
        'label' => lang('ObmpRates.obmp_cancellation_cod'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_cancellation_cod',
    ],
    'obmp_payment_cod' => [
        'label' => lang('ObmpRates.obmp_payment_cod'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_payment_cod',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_rates') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_rate_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_rates') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_rates/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
