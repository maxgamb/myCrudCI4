...
$filterDefinitions = [
    'prodotti_lista_id' => [
        'label' => lang('ProdottiLista.prodotti_lista_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'prodotti_lista_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('prodotti_lista') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'prodotti_lista_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('prodotti_lista') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('prodotti_lista/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
