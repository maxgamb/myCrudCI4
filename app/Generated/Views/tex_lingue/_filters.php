...
$filterDefinitions = [
    'tex_lingue_id' => [
        'label' => lang('TexLingue.tex_lingue_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'etichetta_lg' => [
        'label' => lang('TexLingue.etichetta_lg'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'reparto_id' => [
        'label' => lang('TexLingue.reparto_id'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('tex_lingue') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'tex_lingue_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('tex_lingue') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('tex_lingue/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
