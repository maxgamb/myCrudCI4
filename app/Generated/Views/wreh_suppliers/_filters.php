...
$filterDefinitions = [
    'supplier_id' => [
        'label' => lang('WrehSuppliers.supplier_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('wreh_suppliers') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'supplier_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('wreh_suppliers') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('wreh_suppliers/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
