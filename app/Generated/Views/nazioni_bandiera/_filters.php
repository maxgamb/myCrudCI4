...
$filterDefinitions = [
    'nazione_iso2' => [
        'label' => lang('NazioniBandiera.nazione_iso2'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('nazioni_bandiera') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'nazione_iso2') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('nazioni_bandiera') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('nazioni_bandiera/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
