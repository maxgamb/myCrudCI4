...
$filterDefinitions = [
    'doc_files_id' => [
        'label' => lang('DocFile.doc_files_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('doc_file') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'doc_files_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('doc_file') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('doc_file/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
