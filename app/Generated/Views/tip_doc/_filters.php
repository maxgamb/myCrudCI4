...
$filterDefinitions = [
  ...
  6 => 'not_null',
    ...
    'Doc_Descrizione' => [
        'label' => lang('TipDoc.Doc_Descrizione'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('tip_doc') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'tip_doc_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('tip_doc') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('tip_doc/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
