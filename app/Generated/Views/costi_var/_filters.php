...
$filterDefinitions = [
    'costi_var_id' => [
        'label' => lang('CostiVar.costi_var_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'costi_area_id' => [
        'label' => lang('CostiVar.costi_area_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('costi_var') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'costi_var_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('costi_var') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('costi_var/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
