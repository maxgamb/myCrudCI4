            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="foglio_id"
                        id="foglio_id"
                        value="<?= esc(old('foglio_id', $row->foglio_id ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pag_room"
                        id="pag_room"
                        value="<?= esc(old('pag_room', $row->pag_room ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="aliquota"
                        id="aliquota"
                        value="<?= esc(old('aliquota', $row->aliquota ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quan_room"
                        id="quan_room"
                        value="<?= esc(old('quan_room', $row->quan_room ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pag_extra"
                        id="pag_extra"
                        value="<?= esc(old('pag_extra', $row->pag_extra ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="extra_aliquota"
                        id="extra_aliquota"
                        value="<?= esc(old('extra_aliquota', $row->extra_aliquota ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pag_citytax"
                        id="pag_citytax"
                        value="<?= esc(old('pag_citytax', $row->pag_citytax ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pagamentoTipo"
                        id="pagamentoTipo"
                        value="<?= esc(old('pagamentoTipo', $row->pagamentoTipo ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="pagamentoCityTax"
                        value="<?= esc(old('pagamentoCityTax', $row->pagamentoCityTax ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="codiceLotteria"
                        id="codiceLotteria"
                        value="<?= esc(old('codiceLotteria', $row->codiceLotteria ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="stringaLotteria"
                        value="<?= esc(old('stringaLotteria', $row->stringaLotteria ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="se_idTrx"
                        id="se_idTrx"
                        value="<?= esc(old('se_idTrx', $row->se_idTrx ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="command"
                        id="command"
                        value="<?= esc(old('command', $row->command ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="errore"
                        id="errore"
                        value="<?= esc(old('errore', $row->errore ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="ae_idTrx"
                        id="ae_idTrx"
                        value="<?= esc(old('ae_idTrx', $row->ae_idTrx ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="numeroDocumento"
                        value="<?= esc(old('numeroDocumento', $row->numeroDocumento ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('numeroRiferimento', $row->numeroRiferimento ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="totaleScontrino"
                        value="<?= esc(old('totaleScontrino', $row->totaleScontrino ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="totaleIva"
                        id="totaleIva"
                        value="<?= esc(old('totaleIva', $row->totaleIva ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="totaleSconto"
                        id="totaleSconto"
                        value="<?= esc(old('totaleSconto', $row->totaleSconto ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('importoDetraibile', $row->importoDetraibile ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="idElemento"
                        id="idElemento"
                        value="<?= esc(old('idElemento', $row->idElemento ?? '')) ?>"
