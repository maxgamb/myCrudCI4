...
<form id="crudFiltersForm" method="get" action="<?= site_url('sales_by_film_category') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'category') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('sales_by_film_category') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('sales_by_film_category/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
