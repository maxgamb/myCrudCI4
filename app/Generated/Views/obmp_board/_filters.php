...
$filterDefinitions = [
    'obmp_board_id' => [
        'label' => lang('ObmpBoard.obmp_board_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_board_title' => [
        'label' => lang('ObmpBoard.obmp_board_title'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'obmp_board_cod' => [
        'label' => lang('ObmpBoard.obmp_board_cod'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_board') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_board_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_board') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_board/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
