            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('cambio_biancheria', $row->cambio_biancheria ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pulizia_stato"
                        id="pulizia_stato"
                        value="<?= esc(old('pulizia_stato', $row->pulizia_stato ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pulizia_data"
                        id="pulizia_data"
                        value="<?= esc(old('pulizia_data', $row->pulizia_data ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pulizia_note"
                        id="pulizia_note"
                        value="<?= esc(old('pulizia_note', $row->pulizia_note ?? '')) ?>"
