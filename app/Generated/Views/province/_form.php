            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        maxlength="30"
                    >
                    <?php if (!empty($errors['Prov'])): ?>
                        <div id="Prov-error" class="invalid-feedback d-block">
                            <?= esc($errors['Prov']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="ColExcel" class="form-label">
                        <?= esc(lang('Province.ColExcel')) ?>
                    </label>
                    <input
                        type="text"
                        name="ColExcel"
                        ...
                        maxlength="30"
                    >
                    <?php if (!empty($errors['ColExcel'])): ?>
                        <div id="ColExcel-error" class="invalid-feedback d-block">
                            <?= esc($errors['ColExcel']) ?>
                        </div>
                    <?php endif; ?>
                </div>
