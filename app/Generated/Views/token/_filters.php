...
<form id="crudFiltersForm" method="get" action="<?= site_url('token') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'token_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('token') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('token/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
