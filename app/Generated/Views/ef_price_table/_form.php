            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="single"
                        id="single"
                        value="<?= esc(old('single', $row->single ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="single_plus"
                        id="single_plus"
                        value="<?= esc(old('single_plus', $row->single_plus ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="student"
                        id="student"
                        value="<?= esc(old('student', $row->student ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="fam_tr"
                        id="fam_tr"
                        value="<?= esc(old('fam_tr', $row->fam_tr ?? '')) ?>"
