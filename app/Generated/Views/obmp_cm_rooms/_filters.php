...
$filterDefinitions = [
    'obmp_cm_rooms_id' => [
        'label' => lang('ObmpCmRooms.obmp_cm_rooms_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_cm_id' => [
        'label' => lang('ObmpCmRooms.obmp_cm_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'obmp_cm_rooms_attiva' => [
        'label' => lang('ObmpCmRooms.obmp_cm_rooms_attiva'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_cm_rooms_tipologia_id' => [
        'label' => lang('ObmpCmRooms.obmp_cm_rooms_tipologia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_cm_rooms_tipologia_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_cm_rooms') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_cm_rooms_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_cm_rooms') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_cm_rooms/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
