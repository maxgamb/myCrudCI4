...
<?= view('film/_children_film_actor__film_id', ['row' => $row, 'children' => $children]) ?>
<?= view('film/_children_film_category__film_id', ['row' => $row, 'children' => $children]) ?>
<?= view('film/_children_inventory__film_id', ['row' => $row, 'children' => $children]) ?>
    </div>
</div>
