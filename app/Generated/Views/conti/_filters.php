...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'conti_stato_camere' => [
        'label' => lang('Conti.conti_stato_camere'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('conti') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'conto_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('conti') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('conti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
