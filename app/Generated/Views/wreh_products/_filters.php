...
$filterDefinitions = [
    'product_id' => [
        'label' => lang('WrehProducts.product_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'costi_area_id' => [
        'label' => lang('WrehProducts.costi_area_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'costi_area_id',
    ],
    'supplier_id' => [
        'label' => lang('WrehProducts.supplier_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('wreh_products') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'product_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('wreh_products') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('wreh_products/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
