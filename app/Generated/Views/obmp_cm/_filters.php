...
$filterDefinitions = [
  ...
  1 => 'neq',
    ...
    'obmp_cm_attiva' => [
        'label' => lang('ObmpCm.obmp_cm_attiva'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_cm') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_cm_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_cm') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_cm/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
