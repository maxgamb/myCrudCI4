...
$filterDefinitions = [
    'obmp_quote_sub_id' => [
        'label' => lang('ObmpQuoteSub.obmp_quote_sub_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_quote_id' => [
        'label' => lang('ObmpQuoteSub.obmp_quote_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obmp_quote_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_quote_sub') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_quote_sub_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_quote_sub') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_quote_sub/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
