            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="guasto_priorita"
                        value="<?= esc(old('guasto_priorita', $row->guasto_priorita ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="guasto_area"
                        id="guasto_area"
                        value="<?= esc(old('guasto_area', $row->guasto_area ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="guasto_piano"
                        id="guasto_piano"
                        value="<?= esc(old('guasto_piano', $row->guasto_piano ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="guasto_note"
                        id="guasto_note"
                        value="<?= esc(old('guasto_note', $row->guasto_note ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="guasto_stato"
                        id="guasto_stato"
                        value="<?= esc(old('guasto_stato', $row->guasto_stato ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="guasto_data"
                        id="guasto_data"
                        value="<?= esc(old('guasto_data', $row->guasto_data ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="guasto_utente_id"
                        value="<?= esc(old('guasto_utente_id', $row->guasto_utente_id ?? '')) ?>"
