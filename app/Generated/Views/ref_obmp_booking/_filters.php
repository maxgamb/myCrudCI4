...
$filterDefinitions = [
    'ref_obm_data' => [
        'label' => lang('RefObmpBooking.ref_obm_data'),
  ...
  8 => 'not_null',
    ...
    'preno_id' => [
        'label' => lang('RefObmpBooking.preno_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'obm_cliente_id' => [
        'label' => lang('RefObmpBooking.obm_cliente_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'obm_cliente_id',
    ],
    'hotel_id' => [
        'label' => lang('RefObmpBooking.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'ref_site' => [
        'label' => lang('RefObmpBooking.ref_site'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'quote_id' => [
        'label' => lang('RefObmpBooking.quote_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ref_obmp_booking') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_obm_data') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ref_obmp_booking') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ref_obmp_booking/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
