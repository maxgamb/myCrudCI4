...
$filterDefinitions = [
    'order_detail_id' => [
        'label' => lang('WrehOrderDetails.order_detail_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'order_id' => [
        'label' => lang('WrehOrderDetails.order_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'product_id' => [
        'label' => lang('WrehOrderDetails.product_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('wreh_order_details') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'order_detail_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('wreh_order_details') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('wreh_order_details/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
