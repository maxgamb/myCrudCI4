...
$filterDefinitions = [
    'prezzi_competitori_id' => [
        'label' => lang('PrezziCompetitori.prezzi_competitori_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('PrezziCompetitori.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'data_prezzo' => [
        'label' => lang('PrezziCompetitori.data_prezzo'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('prezzi_competitori') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'prezzi_competitori_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('prezzi_competitori') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('prezzi_competitori/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
