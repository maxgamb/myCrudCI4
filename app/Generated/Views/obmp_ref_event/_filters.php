...
$filterDefinitions = [
    'ref_event_id' => [
        'label' => lang('ObmpRefEvent.ref_event_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'ref_site_id' => [
        'label' => lang('ObmpRefEvent.ref_site_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'ref_site_id',
    ],
    'hotel_id' => [
        'label' => lang('ObmpRefEvent.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'listino_nome_id' => [
        'label' => lang('ObmpRefEvent.listino_nome_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'listino_nome_id',
    ],
    'agenzia_id' => [
        'label' => lang('ObmpRefEvent.agenzia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_ref_event') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_event_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_ref_event') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_ref_event/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
