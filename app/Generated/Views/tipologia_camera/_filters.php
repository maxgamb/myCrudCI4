...
$filterDefinitions = [
    'tipologia_id' => [
        'label' => lang('TipologiaCamera.tipologia_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('tipologia_camera') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'tipologia_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('tipologia_camera') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('tipologia_camera/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
