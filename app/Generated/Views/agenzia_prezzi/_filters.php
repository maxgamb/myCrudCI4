...
$filterDefinitions = [
    'agenzia_prezzi_id' => [
        'label' => lang('AgenziaPrezzi.agenzia_prezzi_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'agenzia_prezzi_id',
    ],
    'hotel_id' => [
        'label' => lang('AgenziaPrezzi.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('agenzia_prezzi') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'agenzia_prezzi_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('agenzia_prezzi') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('agenzia_prezzi/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
