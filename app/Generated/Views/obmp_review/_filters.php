...
$filterDefinitions = [
    'review_id' => [
        'label' => lang('ObmpReview.review_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('ObmpReview.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'preno_id' => [
        'label' => lang('ObmpReview.preno_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'conto_id' => [
        'label' => lang('ObmpReview.conto_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'postazione_id' => [
        'label' => lang('ObmpReview.postazione_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_review') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'review_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_review') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_review/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
