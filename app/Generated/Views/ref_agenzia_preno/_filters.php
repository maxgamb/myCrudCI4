...
$filterDefinitions = [
    'ref_agenzia_preno' => [
        'label' => lang('RefAgenziaPreno.ref_agenzia_preno'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'agenzia_id' => [
        'label' => lang('RefAgenziaPreno.agenzia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'preno_id' => [
        'label' => lang('RefAgenziaPreno.preno_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ref_agenzia_preno') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_agenzia_preno') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ref_agenzia_preno') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ref_agenzia_preno/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
