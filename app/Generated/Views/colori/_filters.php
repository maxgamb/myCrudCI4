...
$filterDefinitions = [
    'colore_codice' => [
        'label' => lang('Colori.colore_codice'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'col_preno_id' => [
        'label' => lang('Colori.col_preno_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'col_preno_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('colori') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'colore_nome') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('colori') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('colori/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
