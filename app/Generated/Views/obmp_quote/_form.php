            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_lg"
                        id="quote_lg"
                        value="<?= esc(old('quote_lg', $row->quote_lg ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_dal"
                        id="quote_dal"
                        value="<?= esc(old('quote_dal', $row->quote_dal ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_al"
                        id="quote_al"
                        value="<?= esc(old('quote_al', $row->quote_al ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_titolo"
                        id="quote_titolo"
                        value="<?= esc(old('quote_titolo', $row->quote_titolo ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_cognome"
                        id="quote_cognome"
                        value="<?= esc(old('quote_cognome', $row->quote_cognome ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_nome"
                        id="quote_nome"
                        value="<?= esc(old('quote_nome', $row->quote_nome ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_email"
                        id="quote_email"
                        value="<?= esc(old('quote_email', $row->quote_email ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="trattamento_id"
                        id="trattamento_id"
                        value="<?= esc(old('trattamento_id', $row->trattamento_id ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="trariffa_id"
                        id="trariffa_id"
                        value="<?= esc(old('trariffa_id', $row->trariffa_id ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="cax_policy_id"
                        id="cax_policy_id"
                        value="<?= esc(old('cax_policy_id', $row->cax_policy_id ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_tel_rich"
                        id="quote_tel_rich"
                        value="<?= esc(old('quote_tel_rich', $row->quote_tel_rich ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_cc_rich"
                        id="quote_cc_rich"
                        value="<?= esc(old('quote_cc_rich', $row->quote_cc_rich ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_del"
                        id="quote_del"
                        value="<?= esc(old('quote_del', $row->quote_del ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="quote_data_time"
                        value="<?= esc(old('quote_data_time', isset($row->quote_data_time) ? str_replace(' ', 'T', substr((string) $row->quote_data_time, 0, 16)) : '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="quote_stato"
                        id="quote_stato"
                        value="<?= esc(old('quote_stato', $row->quote_stato ?? '')) ?>"
