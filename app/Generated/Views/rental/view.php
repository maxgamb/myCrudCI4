...
<div class="card shadow-sm mt-4">
        <div class="card-header d-flex justify-content-between align-items-center gap-2">
            ...
            <div class="d-flex align-items-center gap-2 d-print-none">
                <a href="<?= site_url('payment/create') . '?' . http_build_query(['rental_id' => $row->{'rental_id'} ?? '']) ?>" class="btn btn-sm btn-primary" title="Nuovo record collegato"><i class="bi bi-plus-circle me-1" aria-hidden="true"></i> Nuovo</a>
            ...
            <?php else: ?>
                ...
                <?php if (!empty($children['payment__rental_id']['hasMore'])): ?>
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 d-print-none">
                        ...
                        <a href="<?= site_url('payment') . '?' . http_build_query(['rental_id' => $row->{'rental_id'} ?? '']) ?>" class="btn btn-sm btn-outline-primary">
