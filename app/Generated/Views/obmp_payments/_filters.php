...
$filterDefinitions = [
    'obmp_payment_id' => [
        'label' => lang('ObmpPayments.obmp_payment_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_payment_cod' => [
        'label' => lang('ObmpPayments.obmp_payment_cod'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_payments') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_payment_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_payments') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_payments/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
