...
<form id="crudFiltersForm" method="get" action="<?= site_url('nicer_but_slower_film_list') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'FID') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('nicer_but_slower_film_list') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('nicer_but_slower_film_list/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
