                    ...
                    <div class="col-12">
                        ...
                        >
                            <div class="offcanvas-header border-bottom">
                                <div>
                                    <h2 class="offcanvas-title h5 mb-0" id="related_create_actor_id_label">New Actor</h2>
                                    <small class="text-muted">Relation actor_id</small>
                                </div>
                                <button
                                    type="button"
                            ...
                            <div class="offcanvas-body">
                                <div class="alert alert-light border small" role="note">
                                    Enter the new Actor data. The related record and this record will be saved together when the main form is submitted, within the same transaction.
                                </div>
