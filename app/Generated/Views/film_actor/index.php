...
<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a id="createRecordButton" data-base-url="<?= site_url('film_actor/create') ?>" href="<?= site_url('film_actor/create') . ($navigationQuery ?? '') ?>" class="btn btn-primary" title="New record">
