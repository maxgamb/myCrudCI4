...
<form id="crudFiltersForm" method="get" action="<?= site_url('customer_list') ?>">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('customer_list/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
