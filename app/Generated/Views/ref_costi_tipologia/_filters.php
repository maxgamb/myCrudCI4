...
$filterDefinitions = [
    'ref_costi_tipologia_id' => [
        'label' => lang('RefCostiTipologia.ref_costi_tipologia_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'costi_var_id' => [
        'label' => lang('RefCostiTipologia.costi_var_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'costi_var_id',
    ],
    'tipologia_id' => [
        'label' => lang('RefCostiTipologia.tipologia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ref_costi_tipologia') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_costi_tipologia_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ref_costi_tipologia') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ref_costi_tipologia/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
