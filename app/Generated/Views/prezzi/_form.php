            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="prezzo_dal"
                        id="prezzo_dal"
                        value="<?= esc(old('prezzo_dal', $row->prezzo_dal ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="prezzo_al"
                        id="prezzo_al"
                        value="<?= esc(old('prezzo_al', $row->prezzo_al ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="prezzo_valore"
                        id="prezzo_valore"
                        value="<?= esc(old('prezzo_valore', $row->prezzo_valore ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="libero"
                        id="libero"
                        value="<?= esc(old('libero', $row->libero ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="prezzi_utente_id"
                        value="<?= esc(old('prezzi_utente_id', $row->prezzi_utente_id ?? '')) ?>"
