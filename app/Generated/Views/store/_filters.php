...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'manager_staff_id' => [
        'label' => lang('Store.manager_staff_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'manager_staff_id',
    ],
    'address_id' => [
        'label' => lang('Store.address_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('store') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'store_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('store') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('store/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
