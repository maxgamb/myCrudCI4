                        ...
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                <td>
                                    ...
                                    <?php if ((string) ($row->{'manager_staff_id'} ?? '') !== ''): ?><a href="<?= site_url('staff/view/' . rawurlencode((string) $row->{'manager_staff_id'})) ?>" class="text-decoration-none"><?= esc($row->{'manager_staff_id__label'} ?? $row->{'manager_staff_id'} ?? '') ?></a><?php else: ?><?= esc($row->{'manager_staff_id__label'} ?? '') ?><?php endif; ?>
                                    <?php
                                    $quickQuery = (array) ($query ?? []);
                                ...
                                <td class="text-end text-nowrap">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        ...
                                        <a href="<?= site_url('store/edit/' . rawurlencode((string) $id)) . ($navigationQuery ?? '') ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square" aria-hidden="true"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('store/delete/' . rawurlencode((string) $id)) . ($navigationQuery ?? '') ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
