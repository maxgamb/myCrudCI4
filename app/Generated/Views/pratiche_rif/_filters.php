...
$filterDefinitions = [
    'pratica_rif_pratica_id' => [
        'label' => lang('PraticheRif.pratica_rif_pratica_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('PraticheRif.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'pratica_rif_conto_id' => [
        'label' => lang('PraticheRif.pratica_rif_conto_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'pratiche_rif_id' => [
        'label' => lang('PraticheRif.pratiche_rif_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'pratiche_rif_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('pratiche_rif') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'pratica_rif_pratica_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('pratiche_rif') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('pratiche_rif/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
