...
final class AgendaRules
{
  ...
  'preno_n_notti' => 'required|integer',
  'preno_arr_ore' => 'permit_empty|max_length[20]',
  'preno_trattamento' => 'required|exact_length[3]',
  't1' => 'required|integer',
  'q1' => 'required|integer',
  'p1' => 'required|decimal',
  ...
  'preno_doc_email' => 'permit_empty|exact_length[2]',
  ...
  'cancella_data_record' => 'permit_empty|valid_date',
