...
final class AgendaRules
{
  ...
  'preno_trattamento' => 'required|max_length[3]',
  't1' => 'required|integer',
  'q1' => 'required|integer',
  'p1' => 'required|decimal',
  ...
  'nazione_iso2' => 'permit_empty|max_length[5]',
  'preno_note' => 'permit_empty|max_length[4294967295]',
  'preno_doc_fax' => 'permit_empty|max_length[2]',
  'preno_doc_email' => 'permit_empty|max_length[2]',
  'preno_doc_form' => 'permit_empty|max_length[2]',
  'preno_doc_mail' => 'permit_empty|max_length[2]',
  'preno_doc_vaglia' => 'permit_empty|max_length[2]',
  'preno_doc_woucher' => 'permit_empty|max_length[2]',
  ...
  'preno_data_record' => 'required|valid_date',
