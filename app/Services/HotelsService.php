...
final class HotelsService
{
  ...
  'hotel_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly HotelsModel $model = new HotelsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new HotelsEntity($data), true);
        if ($id === false) {
