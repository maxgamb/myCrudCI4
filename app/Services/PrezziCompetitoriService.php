...
use App\Models\PrezziCompetitoriModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class PrezziCompetitoriService
{
    ...
    public function __construct(private readonly PrezziCompetitoriModel $model = new PrezziCompetitoriModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new PrezziCompetitoriEntity($data), true);
        if ($id === false) {
