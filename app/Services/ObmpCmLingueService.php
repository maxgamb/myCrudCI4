...
use App\Models\ObmpCmLingueModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpCmLingueService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'obmp_cm_lingue_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly ObmpCmLingueModel $model = new ObmpCmLingueModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpCmLingueEntity($data), true);
        if ($id === false) {
