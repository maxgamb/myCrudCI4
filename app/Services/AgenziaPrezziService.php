...
use App\Models\AgenziaPrezziModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class AgenziaPrezziService
{
    ...
    public function __construct(private readonly AgenziaPrezziModel $model = new AgenziaPrezziModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new AgenziaPrezziEntity($data), true);
        if ($id === false) {
