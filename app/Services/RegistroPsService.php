...
use App\Models\RegistroPsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class RegistroPsService
{
    ...
    public function __construct(private readonly RegistroPsModel $model = new RegistroPsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new RegistroPsEntity($data), true);
        if ($id === false) {
