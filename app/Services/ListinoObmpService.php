...
use App\Models\ListinoObmpModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ListinoObmpService
{
    ...
    public function __construct(private readonly ListinoObmpModel $model = new ListinoObmpModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ListinoObmpEntity($data), true);
        if ($id === false) {
