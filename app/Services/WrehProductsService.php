...
use App\Models\WrehProductsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class WrehProductsService
{
    ...
    public function __construct(private readonly WrehProductsModel $model = new WrehProductsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new WrehProductsEntity($data), true);
        if ($id === false) {
