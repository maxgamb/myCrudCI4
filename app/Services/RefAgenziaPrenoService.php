...
use App\Models\RefAgenziaPrenoModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class RefAgenziaPrenoService
{
    ...
    public function __construct(private readonly RefAgenziaPrenoModel $model = new RefAgenziaPrenoModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new RefAgenziaPrenoEntity($data), true);
        if ($id === false) {
