...
use App\Models\ListinoPeriodiObmpModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ListinoPeriodiObmpService
{
    ...
    public function __construct(private readonly ListinoPeriodiObmpModel $model = new ListinoPeriodiObmpModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ListinoPeriodiObmpEntity($data), true);
        if ($id === false) {
