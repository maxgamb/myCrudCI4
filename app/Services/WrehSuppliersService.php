...
use App\Models\WrehSuppliersModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class WrehSuppliersService
{
    ...
    public function __construct(private readonly WrehSuppliersModel $model = new WrehSuppliersModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new WrehSuppliersEntity($data), true);
        if ($id === false) {
