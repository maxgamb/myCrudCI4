...
use App\Models\ModificaAgendaModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ModificaAgendaService
{
    ...
    public function __construct(private readonly ModificaAgendaModel $model = new ModificaAgendaModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ModificaAgendaEntity($data), true);
        if ($id === false) {
