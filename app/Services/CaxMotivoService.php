...
final class CaxMotivoService
{
    ...
    public function __construct(private readonly CaxMotivoModel $model = new CaxMotivoModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new CaxMotivoEntity($data), true);
        if ($id === false) {
