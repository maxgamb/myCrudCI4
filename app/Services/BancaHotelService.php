...
use App\Models\BancaHotelModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class BancaHotelService
{
    ...
    public function __construct(private readonly BancaHotelModel $model = new BancaHotelModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new BancaHotelEntity($data), true);
        if ($id === false) {
