...
use App\Models\WinBookingModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class WinBookingService
{
    ...
    public function __construct(private readonly WinBookingModel $model = new WinBookingModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new WinBookingEntity($data), true);
        if ($id === false) {
