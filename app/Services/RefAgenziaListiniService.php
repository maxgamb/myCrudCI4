...
use App\Models\RefAgenziaListiniModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class RefAgenziaListiniService
{
    ...
    public function __construct(private readonly RefAgenziaListiniModel $model = new RefAgenziaListiniModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new RefAgenziaListiniEntity($data), true);
        if ($id === false) {
