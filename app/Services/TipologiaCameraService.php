...
final class TipologiaCameraService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'tipologia_camera_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly TipologiaCameraModel $model = new TipologiaCameraModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new TipologiaCameraEntity($data), true);
        if ($id === false) {
