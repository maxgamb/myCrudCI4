...
use App\Models\EmailAiHistoryModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class EmailAiHistoryService
{
    ...
    public function __construct(private readonly EmailAiHistoryModel $model = new EmailAiHistoryModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new EmailAiHistoryEntity($data), true);
        if ($id === false) {
