...
final class LettereService
{
    ...
    public function __construct(private readonly LettereModel $model = new LettereModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new LettereEntity($data), true);
        if ($id === false) {
