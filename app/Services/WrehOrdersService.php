...
use App\Models\WrehOrdersModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class WrehOrdersService
{
    ...
    public function __construct(private readonly WrehOrdersModel $model = new WrehOrdersModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new WrehOrdersEntity($data), true);
        if ($id === false) {
