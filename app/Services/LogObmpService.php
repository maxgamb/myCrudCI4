...
final class LogObmpService
{
    ...
    public function __construct(private readonly LogObmpModel $model = new LogObmpModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new LogObmpEntity($data), true);
        if ($id === false) {
