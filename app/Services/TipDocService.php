...
final class TipDocService
{
    ...
    public function __construct(private readonly TipDocModel $model = new TipDocModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new TipDocEntity($data), true);
        if ($id === false) {
