...
final class FoglioGiornoService
{
  ...
  'foglio_data_record' => 'Y-m-d H:i:s',
    ...
    public function __construct(private readonly FoglioGiornoModel $model = new FoglioGiornoModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new FoglioGiornoEntity($data), true);
        if ($id === false) {
