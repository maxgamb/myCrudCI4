...
use App\Models\NoteUtenteModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class NoteUtenteService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'note_utente_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly NoteUtenteModel $model = new NoteUtenteModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new NoteUtenteEntity($data), true);
        if ($id === false) {
