...
use App\Models\LogObmpFullModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class LogObmpFullService
{
    ...
    public function __construct(private readonly LogObmpFullModel $model = new LogObmpFullModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new LogObmpFullEntity($data), true);
        if ($id === false) {
