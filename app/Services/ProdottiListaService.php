...
use App\Models\ProdottiListaModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ProdottiListaService
{
    ...
    public function __construct(private readonly ProdottiListaModel $model = new ProdottiListaModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ProdottiListaEntity($data), true);
        if ($id === false) {
