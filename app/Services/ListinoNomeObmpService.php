...
use App\Models\ListinoNomeObmpModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ListinoNomeObmpService
{
    ...
    public function __construct(private readonly ListinoNomeObmpModel $model = new ListinoNomeObmpModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ListinoNomeObmpEntity($data), true);
        if ($id === false) {
