...
use App\Models\CiSessionsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class CiSessionsService
{
    ...
    public function __construct(private readonly CiSessionsModel $model = new CiSessionsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new CiSessionsEntity($data), true);
        if ($id === false) {
