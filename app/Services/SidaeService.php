...
final class SidaeService
{
  ...
  'data_record' => 'Y-m-d H:i:s',
    ...
    public function __construct(private readonly SidaeModel $model = new SidaeModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new SidaeEntity($data), true);
        if ($id === false) {
