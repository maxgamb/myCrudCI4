...
use App\Models\ObmpRestrictionsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpRestrictionsService
{
    ...
    public function __construct(private readonly ObmpRestrictionsModel $model = new ObmpRestrictionsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpRestrictionsEntity($data), true);
        if ($id === false) {
