...
final class RegioniService
{
    ...
    public function __construct(private readonly RegioniModel $model = new RegioniModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new RegioniEntity($data), true);
        if ($id === false) {
