...
use App\Models\ObmpRefSiteModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpRefSiteService
{
    ...
    public function __construct(private readonly ObmpRefSiteModel $model = new ObmpRefSiteModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpRefSiteEntity($data), true);
        if ($id === false) {
