...
final class ObmpQuoteService
{
    ...
    public function __construct(private readonly ObmpQuoteModel $model = new ObmpQuoteModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpQuoteEntity($data), true);
        if ($id === false) {
