...
use App\Models\ManutenzioniModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ManutenzioniService
{
    private const PASSWORD_FIELDS = array (
);
    private const AUTOMATIC_DATE_FIELDS = array (
  'manut_data_record' => 'Y-m-d H:i:s',
);

    public function __construct(private readonly ManutenzioniModel $model = new ManutenzioniModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ManutenzioniEntity($data), true);
        if ($id === false) {
