...
use App\Models\ObmpCancellationsModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class ObmpCancellationsService
{
    ...
    public function __construct(private readonly ObmpCancellationsModel $model = new ObmpCancellationsModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new ObmpCancellationsEntity($data), true);
        if ($id === false) {
