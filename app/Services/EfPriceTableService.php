...
use App\Models\EfPriceTableModel;
use RuntimeException;

/** Coordina la logica applicativa senza comporre query SQL. */
final class EfPriceTableService
{
    ...
    public function __construct(private readonly EfPriceTableModel $model = new EfPriceTableModel())
    {
    }
    ...
    public function create(array $data): int|string
    {
        ...
        $id = $this->model->insert(new EfPriceTableEntity($data), true);
        if ($id === false) {
