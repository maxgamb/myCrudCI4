 ...
 */
final class FilmActorModel extends BaseCrudModel
{
  ...
  1 => 'film_id',
    ...
    /**
     * Returns ready-to-render options for the explicit actor_id belongsTo relation.
  ...
  'displayTemplate' => '',
        ...
        foreach ($rows as $row) {
            ...
            $options[(string) ($row['actor_id'] ?? '')] = $this->formatRelationLabel($row, $definition);
        }
        return $options;
    }
    /**
  ...
  1 => 'name',
    ...
    /** Searches options for explicit belongsTo relation actor_id. */
    public function searchActorIdOptions(string $query, int $limit = 20): array
    {
        $definition = array (
  'displayField' => 'last_name',
  'displayTemplate' => '',
  ...
  0 => 'last_name',
    ...
    /** Finds one option for explicit belongsTo relation actor_id. */
    public function findActorIdOption(int|string $id): ?array
    {
        $definition = array (
  'displayField' => 'last_name',
  'displayTemplate' => '',
  ...
  0 => 'title',
    ...
    {
        return [
            'actor_id' => $this->getActorActorIdOptions(),
    ...
    {
        switch ($field) {
            case 'actor_id': return $this->searchActorIdOptions($query, $limit);
    ...
    {
        switch ($field) {
            case 'actor_id': return $this->findActorIdOption($id);
