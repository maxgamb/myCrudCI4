...
/** Model per film_category; tutte le query del CRUD sono centralizzate qui. */
final class FilmCategoryModel extends Model
{
  ...
  array (
    ...
    private function applyListFilters(BaseBuilder $builder, array $filters, bool $qualified): void
    {
        ...
        foreach (array_values($filters) as $filter) {
            ...
            $column = $qualified ? 'film_category.' . $field : $field;
    ...
    /** Restituisce le opzioni della relazione category_id. */
  ...
  1 => 'title',
    ...
    {
        return [
            'category_id' => $this->toRelationOptions($this->getCategoryCategoryIdOptions(), 'category_id'),
