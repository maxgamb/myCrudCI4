...
final class ProdottiListaModel extends Model
{
  ...
  array (
    ...
    public function baseBuilder(): BaseBuilder
    {
        ...
        $builder->select([
            ...
            'prodotti__prodotti_lista_id.nome_prodotto AS prodotti__prodotti_lista_id__label'
        ]);
  ...
  1 => 'nome_prodotto',
    ...
    {
        return [
            'prodotti_lista_id' => $this->toRelationOptions($this->getProdottiProdottiListaIdOptions(), 'prodotti_lista_id'),
        ];
    }
