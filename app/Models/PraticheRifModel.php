...
final class PraticheRifModel extends Model
{
  ...
  array (
    ...
    public function baseBuilder(): BaseBuilder
    {
        ...
        $builder->select([
            ...
            'pratiche__pratiche_rif_id.pratica_nome AS pratiche__pratiche_rif_id__label'
        ]);
  ...
  1 => 'pratica_nome',
    ...
    {
        return [
            'pratiche_rif_id' => $this->toRelationOptions($this->getPratichePraticheRifIdOptions(), 'pratiche_rif_id'),
        ];
    }
