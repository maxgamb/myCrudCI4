...
final class SospesiModel extends Model
{
  ...
  array (
    ...
    public function baseBuilder(): BaseBuilder
    {
        ...
        $builder->select([
            ...
            'agenzie__sopeso_societa.agenzia_tipologia AS agenzie__sopeso_societa__label',
            'pratiche__sospeso_pratica_id.pratica_nome AS pratiche__sospeso_pratica_id__label'
        ]);
  ...
  1 => 'pratica_nome',
    ...
    {
        return [
            'sopeso_societa' => $this->toRelationOptions($this->getAgenzieSopesoSocietaOptions(), 'sopeso_societa'),
            'sospeso_pratica_id' => $this->toRelationOptions($this->getPraticheSospesoPraticaIdOptions(), 'sospeso_pratica_id'),
        ];
    }
