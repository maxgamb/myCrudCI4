...
/** Model read-only per SQL VIEW actor_info; estendere manualmente solo se necessario. */
final class ActorInfoModel extends Model
{
  ...
  3 => 'film_info',
    ...
    private function applyListFilters(BaseBuilder $builder, array $filters, bool $qualified): void
    {
        ...
        foreach (array_values($filters) as $filter) {
            ...
            $column = $qualified ? 'actor_info.' . $field : $field;
