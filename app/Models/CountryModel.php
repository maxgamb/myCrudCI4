...
/** Model per country; tutte le query del CRUD sono centralizzate qui. */
  ...
  0 => 'country_id',
    ...
    private function applyListFilters(BaseBuilder $builder, array $filters, bool $qualified): void
    {
        ...
        foreach (array_values($filters) as $filter) {
            ...
            $column = $qualified ? 'country.' . $field : $field;
    ...
    public function getCityByCountryId(int|string $parentId, int $limit = 20): array
    {
        ...
        $rows = $this->db->table('city')
            ->select(array (
  0 => 'city.city_id AS city_id',
  1 => 'city.city AS city',
  2 => 'city.country_id AS country_id',
  3 => 'city.last_update AS last_update',
))
