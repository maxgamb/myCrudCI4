  ...
  array (
    ...
    public function baseBuilder(): BaseBuilder
    {
        ...
        $builder->select([
            ...
            'agenzia_listini__agenzia_listini_id.agenzia_listini_nome AS agenzia_listini_agenzia_listini_nome',
    ...
    {
        return [
            'agenzia_listini_id' => $this->toOptions($this->getAgenziaListiniAgenziaListiniIdOptions(), 'agenzia_listini_id', 'agenzia_listini_nome'),
