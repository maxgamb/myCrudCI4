...
$filterDefinitions = [
    'isoKey' => [
        'label' => lang('NazioniLinque.isoKey'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('nazioni_linque') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'isoKey') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('nazioni_linque') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('nazioni_linque/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
