...
$filterDefinitions = [
    'ref_site_id' => [
        'label' => lang('ObmpRefSite.ref_site_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('ObmpRefSite.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obmp_affiliati_id' => [
        'label' => lang('ObmpRefSite.obmp_affiliati_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_ref_site') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_site_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_ref_site') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_ref_site/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
