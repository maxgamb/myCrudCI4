...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'inventory_id' => [
        'label' => lang('Rental.inventory_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'inventory_id',
    ],
    'customer_id' => [
        'label' => lang('Rental.customer_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('rental') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'rental_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('rental') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('rental/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
