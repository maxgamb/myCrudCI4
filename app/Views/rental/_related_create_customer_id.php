...
<div class="row g-3">
            <div class="col-md-6">
                ...
                <input
                    ...
                    value="<?= esc((string) (($relatedPayloadState['customer_id']['store_id'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['customer_id__related__store_id']) ? 'is-invalid' : '' ?> crud-related-create-field"
                ...
                <input
                    ...
                    value="<?= esc((string) (($relatedPayloadState['customer_id']['address_id'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['customer_id__related__address_id']) ? 'is-invalid' : '' ?> crud-related-create-field"
                    data-related-field="customer_id"
                    <?= $relatedCreateActive ? '' : 'disabled' ?>
                     required
                ...
                <div class="form-check">
                    ...
                    >
                </div>                <?php if (!empty($errors['customer_id__related__active'])): ?>
