...
<div class="container py-4 pb-0">
    <nav aria-label="breadcrumb" class="mb-2">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="<?= site_url('film_category') . $navigationQuery ?>">film_category</a></li>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <?php else: ?>
            <a href="<?= site_url('film_category') . $navigationQuery ?>" class="btn btn-outline-secondary" title="Torna alla lista">
...
<?= view('film_category/_form', [
    ...
    'formAction'        => site_url('film_category/store') . $navigationQuery,
    'row'               => $row ?? null,
    'errors'            => $errors ?? [],
    'options'           => $options ?? [],
    'context'           => $context ?? [],
