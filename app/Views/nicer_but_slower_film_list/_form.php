            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="FID" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.FID')) ?>
                    </label>
                    <input
                        type="number"
                        name="FID"
                ...
                <div class="col-md-6">
                    <label for="title" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.title')) ?>
                    </label>
                    <input
                        type="text"
                        name="title"
                ...
                <div class="col-md-6">
                    <label for="description" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.description')) ?>
                    </label>
                    <textarea
                        name="description"
                        id="description"
                ...
                <div class="col-md-6">
                    <label for="category" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.category')) ?>
                    </label>
                    <input
                        type="text"
                        name="category"
                ...
                <div class="col-md-6">
                    <label for="price" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.price')) ?>
                    </label>
                    <input
                        type="number"
                        name="price"
                ...
                <div class="col-md-6">
                    <label for="length" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.length')) ?>
                    </label>
                    <input
                        type="number"
                        name="length"
                ...
                <div class="col-md-6">
                    <label for="rating" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.rating')) ?>
                    </label>
                    <input
                        type="text"
                        name="rating"
                ...
                <div class="col-md-6">
                    <label for="actors" class="form-label">
                        <?= esc(lang('NicerButSlowerFilmList.actors')) ?>
                    </label>
                    <textarea
                        name="actors"
                        id="actors"
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <a href="<?= site_url('nicer_but_slower_film_list') ?>" class="btn btn-secondary">
