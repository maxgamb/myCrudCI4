                ...
                <thead class="table-light">
                    <tr>
                        ...
                        <th>
                            ...
                            >
                                <?= esc(lang('ListinoNomeObmp.listino_nome_id')) ?>
                                <?php if (($sort ?? '') === 'listino_nome_id'): ?>
                                    <i class="bi bi-sort-<?= ($direction ?? 'desc') === 'asc' ? 'up' : 'down' ?>"></i>
                                <?php endif; ?>
                            </a>
                        </th>                        <th><?= esc(lang('ListinoNomeObmp.listino_nome')) ?></th>
                        <?php
                        ...
                        </th>                        <th><?= esc(lang('ListinoNomeObmp.yield')) ?></th>
                        <th><?= esc(lang('ListinoNomeObmp.listino_nome_datarecord')) ?></th>
                            ...
                            <tr>
                                <td>
                                    <?php if ((string) ($row->listino_nome_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->listino_nome_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->listino_nome ?? '') ?></td>
                                <td>
                                    <?php if ((string) ($row->hotel_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->hotel_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->yield ?? '') ?></td>
                                <td><?= esc($row->listino_nome_datarecord ?? '') ?></td>
                                <td class="text-end text-nowrap">
                                    <?php $id = $row->listino_nome_id ?? ''; ?>
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        <a href="<?= site_url('listino_nome_obmp/view/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-info" title="Visualizza">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?= site_url('listino_nome_obmp/edit/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('listino_nome_obmp/delete/' . rawurlencode((string) $id)) ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
