...
$filterDefinitions = [
    'conti_trasferisci_id' => [
        'label' => lang('ContiTrasferisci.conti_trasferisci_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'conto_id_ex' => [
        'label' => lang('ContiTrasferisci.conto_id_ex'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('ContiTrasferisci.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'adebito_id' => [
        'label' => lang('ContiTrasferisci.adebito_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('conti_trasferisci') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'conti_trasferisci_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('conti_trasferisci') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('conti_trasferisci/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
