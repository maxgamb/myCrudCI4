    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="conto_id_ex" class="form-label">
                    ...
                    >
                    <?php if (!empty($errors['conto_id_ex'])): ?>
                        <div id="conto_id_ex-error" class="invalid-feedback d-block">
                            <?= esc($errors['conto_id_ex']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="conto_id_new" class="form-label">
                        <?= esc(lang('ContiTrasferisci.conto_id_new')) ?>
                    </label>
                    <input
                        type="number"
                        name="conto_id_new"
                    ...
                    >
                    <?php if (!empty($errors['conto_id_new'])): ?>
                        <div id="conto_id_new-error" class="invalid-feedback d-block">
                            <?= esc($errors['conto_id_new']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="adebito_id" class="form-label">
                        <?= esc(lang('ContiTrasferisci.adebito_id')) ?>
                    </label>
                    <select
                        name="adebito_id"
                        id="adebito_id"
                        class="form-select <?= isset($errors['adebito_id']) ? 'is-invalid' : '' ?>"
                        aria-describedby="adebito_id-error"
                        aria-invalid="<?= isset($errors['adebito_id']) ? 'true' : 'false' ?>"
                    >
                ...
                <div class="col-md-6">
                    <label for="conti_tra_data" class="form-label">
                        <?= esc(lang('ContiTrasferisci.conti_tra_data')) ?>
                    </label>
                    <input
                        type="datetime-local"
                        name="conti_tra_data"
                    ...
                    >
                    <?php if (!empty($errors['conti_tra_data'])): ?>
                        <div id="conti_tra_data-error" class="invalid-feedback d-block">
                            <?= esc($errors['conti_tra_data']) ?>
                        </div>
                    <?php endif; ?>
                </div>
