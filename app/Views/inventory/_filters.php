...
$filterDefinitions = [
    'inventory_id' => [
        'label' => lang('Inventory.inventory_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('inventory') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'inventory_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('inventory') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('inventory/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
