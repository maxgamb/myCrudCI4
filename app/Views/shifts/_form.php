            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="shift_date"
                        id="shift_date"
                        value="<?= esc(old('shift_date', $row->shift_date ?? ($context['shift_date'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="position"
                        id="position"
                        value="<?= esc(old('position', $row->position ?? ($context['position'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="shift_time"
                        id="shift_time"
                        value="<?= esc(old('shift_time', $row->shift_time ?? ($context['shift_time'] ?? ''))) ?>"
