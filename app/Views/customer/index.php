...
<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a id="createRecordButton" data-base-url="<?= site_url('customer/create') ?>" href="<?= site_url('customer/create') . ($navigationQuery ?? '') ?>" class="btn btn-primary" title="New record">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const navigationContextFields = ["address_id","store_id"];
    const simpleFilterFields = ["last_name","address_id","customer_id","store_id"];
