...
$filterDefinitions = [
  ...
  6 => 'not_null',
    ...
    'address_id' => [
        'label' => lang('Customer.address_id'),
        'input' => 'relation_ajax',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'customer_id' => [
        'label' => lang('Customer.customer_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('customer') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'customer_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('customer') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('customer/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
