            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="conto_id" class="form-label">
                        <?= esc(lang('ReferClienti.conto_id')) ?>
                    </label>
                    <select
                        name="conto_id"
                        id="conto_id"
                ...
                <div class="col-md-6">
                    <label for="clienti_id" class="form-label">
                        <?= esc(lang('ReferClienti.clienti_id')) ?>
                    </label>
                    <input
                        type="number"
                        name="clienti_id"
                ...
                <div class="col-md-6">
                    <label for="hotel_id" class="form-label">
                        <?= esc(lang('ReferClienti.hotel_id')) ?>
                    </label>
                    <input
                        type="number"
                        name="hotel_id"
                ...
                <div class="col-md-6">
                    <label for="ps_valore" class="form-label">
                        <?= esc(lang('ReferClienti.ps_valore')) ?>
                    </label>
                    <input
                        type="number"
                        name="ps_valore"
                        ...
                        required
                    >
                    <?php if (!empty($errors['ps_valore'])): ?>
                        <div id="ps_valore-error" class="invalid-feedback d-block">
                            <?= esc($errors['ps_valore']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="refer_clienti_utente_id" class="form-label">
                        <?= esc(lang('ReferClienti.refer_clienti_utente_id')) ?>
                    </label>
                    <input
                        type="number"
                    ...
                    >
                    <?php if (!empty($errors['refer_clienti_utente_id'])): ?>
                        <div id="refer_clienti_utente_id-error" class="invalid-feedback d-block">
                            <?= esc($errors['refer_clienti_utente_id']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="refer_clienti_conto_id" class="form-label">
                        <?= esc(lang('ReferClienti.refer_clienti_conto_id')) ?>
                    </label>
                    <input
                        type="number"
                        ...
                        required
                    >
                    <?php if (!empty($errors['refer_clienti_conto_id'])): ?>
                        <div id="refer_clienti_conto_id-error" class="invalid-feedback d-block">
                            <?= esc($errors['refer_clienti_conto_id']) ?>
                        </div>
                    <?php endif; ?>
                </div>
