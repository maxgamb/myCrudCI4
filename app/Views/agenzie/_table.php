            ...
            <table class="table table-sm table-striped table-hover align-middle text-nowrap mb-0 crud-table">
                <thead class="table-light">
                    <tr>
                        ...
                        </th>                        <th><?= esc(lang('Agenzie.agenzia_tipologia')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_nome')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_via')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_tel')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_email')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_banca_nome')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_cc_tipo')) ?></th>
                        <th><?= esc(lang('Agenzie.agenzia_cc_nome')) ?></th>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ((string) ($row->hotel_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->hotel_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->agenzia_tipologia ?? '') ?></td>
