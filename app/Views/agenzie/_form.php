            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="agenzia_tipologia" class="form-label">
                        <?= esc(lang('Fields.agenzia_tipologia')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_country" class="form-label">
                        <?= esc(lang('Fields.agenzia_country')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_par_iva" class="form-label">
                        <?= esc(lang('Fields.agenzia_par_iva')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_par_cf" class="form-label">
                        <?= esc(lang('Fields.agenzia_par_cf')) ?>
                    </label>
                    <input
                        type="text"
                        name="agenzia_par_cf"
                ...
                <div class="col-md-6">
                    <label for="agenzia_referente" class="form-label">
                        <?= esc(lang('Fields.agenzia_referente')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_banca_nome" class="form-label">
                        <?= esc(lang('Fields.agenzia_banca_nome')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_banca_iban" class="form-label">
                        <?= esc(lang('Fields.agenzia_banca_iban')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_banca_swift" class="form-label">
                        <?= esc(lang('Fields.agenzia_banca_swift')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_banca_iata" class="form-label">
                        <?= esc(lang('Fields.agenzia_banca_iata')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_cc_tipo" class="form-label">
                        <?= esc(lang('Fields.agenzia_cc_tipo')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_cc_nome" class="form-label">
                        <?= esc(lang('Fields.agenzia_cc_nome')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_cc_numero" class="form-label">
                        <?= esc(lang('Fields.agenzia_cc_numero')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_cc_scadenza" class="form-label">
                        <?= esc(lang('Fields.agenzia_cc_scadenza')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_cc_cod_sicurezza" class="form-label">
                        <?= esc(lang('Fields.agenzia_cc_cod_sicurezza')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_password" class="form-label">
                        <?= esc(lang('Fields.agenzia_password')) ?>
                    </label>
                    <input
                        type="password"
                        name="agenzia_password"
                        id="agenzia_password"
                        value="<?= esc(old('agenzia_password', '')) ?>"
                ...
                <div class="col-md-6">
                    <label for="agenzia_ab_web" class="form-label">
                        <?= esc(lang('Fields.agenzia_ab_web')) ?>
                    </label>
                    <input
                        type="text"
                        name="agenzia_ab_web"
                ...
                <div class="col-md-6">
                    <label for="agenzia_ab_affiliati" class="form-label">
                        <?= esc(lang('Fields.agenzia_ab_affiliati')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_ad_vis" class="form-label">
                        <?= esc(lang('Fields.agenzia_ad_vis')) ?>
                    </label>
                    <input
                        type="text"
                        name="agenzia_ad_vis"
                ...
                <div class="col-md-6">
                    <label for="agenzia_ab_sospeso" class="form-label">
                        <?= esc(lang('Fields.agenzia_ab_sospeso')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="agenzia_data_record" class="form-label">
                        <?= esc(lang('Fields.agenzia_data_record')) ?>
                    </label>
                    <input
                        type="datetime-local"
                        name="agenzia_data_record"
                        id="agenzia_data_record"
                        value="<?= esc(old('agenzia_data_record', isset($row->agenzia_data_record) ? str_replace(' ', 'T', substr((string) $row->agenzia_data_record, 0, 16)) : '')) ?>"
                        class="form-control <?= isset($errors['agenzia_data_record']) ? 'is-invalid' : '' ?>"
                        aria-describedby="agenzia_data_record-error"
                        aria-invalid="<?= isset($errors['agenzia_data_record']) ? 'true' : 'false' ?>"
                        required
                    >
                    <?php if (!empty($errors['agenzia_data_record'])): ?>
                        <div id="agenzia_data_record-error" class="invalid-feedback d-block">
                            <?= esc($errors['agenzia_data_record']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="agenzie_utente_id" class="form-label">
                        <?= esc(lang('Fields.agenzie_utente_id')) ?>
                    </label>
                    <input
                        type="number"
