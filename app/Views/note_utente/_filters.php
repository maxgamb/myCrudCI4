...
$filterDefinitions = [
    'note_utente_id' => [
        'label' => lang('NoteUtente.note_utente_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'Utente_id' => [
        'label' => lang('NoteUtente.Utente_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('note_utente') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'note_utente_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('note_utente') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('note_utente/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
