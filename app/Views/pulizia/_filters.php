...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'pulizia_data' => [
        'label' => lang('Pulizia.pulizia_data'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('pulizia') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'pulizia_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('pulizia') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('pulizia/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
