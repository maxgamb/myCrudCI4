...
$filterDefinitions = [
    'pagamento_id' => [
        'label' => lang('PagamentiSospesi.pagamento_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('PagamentiSospesi.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'sospeso_id' => [
        'label' => lang('PagamentiSospesi.sospeso_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('pagamenti_sospesi') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'pagamento_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('pagamenti_sospesi') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('pagamenti_sospesi/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
