...
$filterDefinitions = [
    'price_ef_is' => [
        'label' => lang('EfPriceTable.price_ef_is'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('EfPriceTable.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ef_price_table') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'price_ef_is') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ef_price_table') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ef_price_table/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
