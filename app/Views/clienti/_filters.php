...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'clienti_nome' => [
        'label' => lang('Clienti.clienti_nome'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'clienti_email' => [
        'label' => lang('Clienti.clienti_email'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('clienti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
