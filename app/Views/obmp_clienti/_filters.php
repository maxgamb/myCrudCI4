...
$filterDefinitions = [
    'obm_cliente_id' => [
        'label' => lang('ObmpClienti.obm_cliente_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'obm_cliente_email' => [
        'label' => lang('ObmpClienti.obm_cliente_email'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_clienti') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obm_cliente_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_clienti') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_clienti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
