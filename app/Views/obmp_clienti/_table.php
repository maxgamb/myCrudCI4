                            ...
                            <tr>
                                <td>
                                    <?php if ((string) ($row->obm_cliente_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->obm_cliente_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->obm_cliente_first_name ?? '') ?></td>
                                <td><?= esc($row->obm_cliente_last_name ?? '') ?></td>
                                <td>
                                    <?php if ((string) ($row->obm_cliente_email ?? '') !== ''): ?>
                                        <?php
                                        $quickFilters = array_values((array) ($filters ?? []));
                                        $quickFilters[] = [
                                            'field' => 'obm_cliente_email',
                                            'operator' => 'eq',
                                            'value' => (string) $row->obm_cliente_email,
                                            'logic' => 'and',
                                        ];
                                        $quickQuery = array_replace((array) ($query ?? []), [
                                            'filters' => $quickFilters,
                                        ...
                                        <a
                                            ...
                                            class="js-list-link text-decoration-none"
                                            title="Filtra per questo valore"
                                        ><?= esc($row->obm_cliente_email) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->obm_cliente_city ?? '') ?></td>
