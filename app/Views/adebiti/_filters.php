...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'prodotto_id' => [
        'label' => lang('Adebiti.prodotto_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'prodotto_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('adebiti') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'adebito_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('adebiti') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('adebiti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
