...
<form id="crudFiltersForm" method="get" action="<?= site_url('app_ip') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'app_ip_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('app_ip') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('app_ip/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
