            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <?php if (!empty($errors['ip_aderss'])): ?>
                        <div id="ip_aderss-error" class="invalid-feedback d-block">
                ...
                <div class="col-md-6">
                    ...
                    <?php if (!empty($errors['Livello'])): ?>
                        <div id="Livello-error" class="invalid-feedback d-block">
                            <?= esc($errors['Livello']) ?>
                        </div>
                    <?php endif; ?>
                </div>
