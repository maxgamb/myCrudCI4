...
$filterDefinitions = [
    'tax_pagamento_id' => [
        'label' => lang('TaxPagamento.tax_pagamento_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('TaxPagamento.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'conto_id' => [
        'label' => lang('TaxPagamento.conto_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'pratica_id' => [
        'label' => lang('TaxPagamento.pratica_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'importo' => [
        'label' => lang('TaxPagamento.importo'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'data_pagamento' => [
        'label' => lang('TaxPagamento.data_pagamento'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('tax_pagamento') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'tax_pagamento_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('tax_pagamento') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('tax_pagamento/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
