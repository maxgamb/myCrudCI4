            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="zip code" class="form-label">
                        <?= esc(lang('CustomerList.zip code')) ?>
                    </label>
                    <input
                        type="text"
                        name="zip code"
                ...
                <div class="col-md-6">
                    <label for="notes" class="form-label">
                        <?= esc(lang('CustomerList.notes')) ?>
                    </label>
                    <input
                        type="text"
                        name="notes"
                        id="notes"
                        value="<?= esc(old('notes', $row->{'notes'} ?? ($context['notes'] ?? ''))) ?>"
                    ...
                    <?php if (!empty($errors['notes'])): ?>
                        <div id="notes-error" class="invalid-feedback d-block">
                            <?= esc($errors['notes']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <a href="<?= site_url('customer_list') ?>" class="btn btn-secondary">
