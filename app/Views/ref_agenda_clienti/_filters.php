...
$filterDefinitions = [
    'ref_agenda_cliente' => [
        'label' => lang('RefAgendaClienti.ref_agenda_cliente'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'preno_id' => [
        'label' => lang('RefAgendaClienti.preno_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'clienti_id' => [
        'label' => lang('RefAgendaClienti.clienti_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ref_agenda_clienti') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_agenda_cliente') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ref_agenda_clienti') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ref_agenda_clienti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
