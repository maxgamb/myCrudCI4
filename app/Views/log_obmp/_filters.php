...
$filterDefinitions = [
    'log_obmp_id' => [
        'label' => lang('LogObmp.log_obmp_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'ref_session' => [
        'label' => lang('LogObmp.ref_session'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('log_obmp') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'log_obmp_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('log_obmp') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('log_obmp/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
