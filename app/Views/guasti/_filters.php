...
$filterDefinitions = [
  ...
  1 => 'neq',
    ...
    'guasto_stato' => [
        'label' => lang('Guasti.guasto_stato'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('guasti') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'guasto_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('guasti') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('guasti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
