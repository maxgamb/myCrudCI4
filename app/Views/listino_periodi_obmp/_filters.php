...
$filterDefinitions = [
    'listino_periodi_id' => [
        'label' => lang('ListinoPeriodiObmp.listino_periodi_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'listino_nome_id' => [
        'label' => lang('ListinoPeriodiObmp.listino_nome_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'listino_dal' => [
        'label' => lang('ListinoPeriodiObmp.listino_dal'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('listino_periodi_obmp') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'listino_periodi_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('listino_periodi_obmp') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('listino_periodi_obmp/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
