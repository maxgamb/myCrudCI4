...
$filterDefinitions = [
  ...
  1 => 'neq',
    ...
    'numeroDocumento' => [
        'label' => lang('Sidae.numeroDocumento'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'numeroRiferimento' => [
        'label' => lang('Sidae.numeroRiferimento'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('sidae') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'sidae_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('sidae') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('sidae/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
