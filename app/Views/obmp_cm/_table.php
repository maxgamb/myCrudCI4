                        ...
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                <td>
                                    ...
                                    <?php endif; ?>                                </td>                                <td><?= esc($row->obmp_cm_id_hotel_agenzia ?? '') ?></td>
                                <td>
                                    <?php if ((string) ($row->obmp_cm_attiva ?? '') !== ''): ?>
                                        <?php
                                        $quickFilters = array_values((array) ($filters ?? []));
                                        $quickFilters[] = [
                                            'field' => 'obmp_cm_attiva',
                                            'operator' => 'eq',
                                            'value' => (string) $row->obmp_cm_attiva,
                                            'logic' => 'and',
                                        ];
                                        $quickQuery = array_replace((array) ($query ?? []), [
                                            'filters' => $quickFilters,
                                        ...
                                        <a
                                            ...
                                            class="js-list-link text-decoration-none"
                                            title="Filtra per questo valore"
                                        ><?= esc($row->obmp_cm_attiva) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->obmp_cm_agenzia_url ?? '') ?></td>
