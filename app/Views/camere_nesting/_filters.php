...
$filterDefinitions = [
    'nesting_id' => [
        'label' => lang('CamereNesting.nesting_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'camara_id' => [
        'label' => lang('CamereNesting.camara_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'tipologia_id' => [
        'label' => lang('CamereNesting.tipologia_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('camere_nesting') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'nesting_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('camere_nesting') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('camere_nesting/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
