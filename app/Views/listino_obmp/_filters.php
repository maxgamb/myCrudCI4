...
$filterDefinitions = [
    'listino_id' => [
        'label' => lang('ListinoObmp.listino_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('ListinoObmp.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'listino_nome_id' => [
        'label' => lang('ListinoObmp.listino_nome_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'tipologia_id' => [
        'label' => lang('ListinoObmp.tipologia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('listino_obmp') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'listino_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('listino_obmp') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('listino_obmp/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
