            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="listino_prezzo"
                        id="listino_prezzo"
                        value="<?= esc(old('listino_prezzo', $row->listino_prezzo ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('listino_obmp_datarecord', isset($row->listino_obmp_datarecord) ? str_replace(' ', 'T', substr((string) $row->listino_obmp_datarecord, 0, 16)) : '')) ?>"
