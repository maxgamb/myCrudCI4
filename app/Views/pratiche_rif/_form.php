    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="pratica_rif_pratica_id" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_pratica_id')) ?>
                    </label>
                    <input
                        type="number"
                    ...
                    >
                    <?php if (!empty($errors['pratica_rif_pratica_id'])): ?>
                        <div id="pratica_rif_pratica_id-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_pratica_id']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="hotel_id" class="form-label">
                        <?= esc(lang('PraticheRif.hotel_id')) ?>
                    </label>
                    <input
                        type="number"
                        name="hotel_id"
                ...
                <div class="col-md-6">
                    <label for="pratica_rif_conto_id" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_conto_id')) ?>
                    </label>
                    <input
                        type="number"
                    ...
                    >
                    <?php if (!empty($errors['pratica_rif_conto_id'])): ?>
                        <div id="pratica_rif_conto_id-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_conto_id']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="pratica_rif_totale_modificato" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_totale_modificato')) ?>
                    </label>
                    <input
                        type="number"
                    ...
                    >
                    <?php if (!empty($errors['pratica_rif_totale_modificato'])): ?>
                        <div id="pratica_rif_totale_modificato-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_totale_modificato']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="pratica_rif_totale_importo" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_totale_importo')) ?>
                    </label>
                    <input
                        type="number"
                    ...
                    >
                    <?php if (!empty($errors['pratica_rif_totale_importo'])): ?>
                        <div id="pratica_rif_totale_importo-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_totale_importo']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="pratica_rif_pagamento_importo_pag" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_pagamento_importo_pag')) ?>
                    </label>
                    <input
                        type="number"
                    ...
                    >
                    <?php if (!empty($errors['pratica_rif_pagamento_importo_pag'])): ?>
                        <div id="pratica_rif_pagamento_importo_pag-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_pagamento_importo_pag']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="pratica_rif_note" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_note')) ?>
                    </label>
                    <input
                        type="text"
                    ...
                    >
                    <?php if (!empty($errors['pratica_rif_note'])): ?>
                        <div id="pratica_rif_note-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_note']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="pratica_rif_out_conto" class="form-label">
                        <?= esc(lang('PraticheRif.pratica_rif_out_conto')) ?>
                    </label>
                    <input
                        type="date"
                        ...
                        required
                    >
                    <?php if (!empty($errors['pratica_rif_out_conto'])): ?>
                        <div id="pratica_rif_out_conto-error" class="invalid-feedback d-block">
                            <?= esc($errors['pratica_rif_out_conto']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="pratiche_rif_id" class="form-label">
                        <?= esc(lang('PraticheRif.pratiche_rif_id')) ?>
                    </label>
                    <select
                        name="pratiche_rif_id"
                        id="pratiche_rif_id"
                        class="form-select <?= isset($errors['pratiche_rif_id']) ? 'is-invalid' : '' ?>"
                        aria-describedby="pratiche_rif_id-error"
                        aria-invalid="<?= isset($errors['pratiche_rif_id']) ? 'true' : 'false' ?>"
                    >
