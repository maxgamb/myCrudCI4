...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header">
            <h1 class="h4 mb-0"><i class="bi bi-plus-circle"></i> Nuovo record</h1>
        </div>
            ...
            <?= form_open('agenda/store', [
                ...
                <div class="col-md-12">
                    ...
                    <input
                        ...
                        id="preno_impoto_mod"
                        value="<?= esc(old('preno_impoto_mod')) ?>"
                    ...
                    >
                        ...
                        <?php foreach (($options['preno_arr_ore'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                ...
                                <?= (string) old('preno_arr_ore') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-6">
                    ...
                    >
                        ...
                        <?php foreach (($options['preno_trattamento'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('preno_trattamento') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <?php foreach (($options['t1'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('t1') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <?php foreach (($options['t2'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('t2') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <?php foreach (($options['t3'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('t3') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <?php foreach (($options['t4'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('t4') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <?php foreach (($options['t5'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('t5') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <?php foreach (($options['t6'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('t6') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-6">
                    ...
                    >
                        ...
                        <?php foreach (($options['preno_agenzia'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('preno_agenzia') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-6">
                    ...
                    >
                        ...
                        <?php foreach (($options['preno_cc_tip'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('preno_cc_tip') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-6">
                    ...
                    >
                        ...
                        <?php foreach (($options['nazione_iso2'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('nazione_iso2') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-6">
                    ...
                    >
                        ...
                        <?php foreach (($options['preno_pag_modalita'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('preno_pag_modalita') === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('cancella_data_record')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('preno_data_record')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="agenda_utente_id"
                        value="<?= esc(old('agenda_utente_id')) ?>"
