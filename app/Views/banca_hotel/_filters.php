...
$filterDefinitions = [
    'banca_hotel_id' => [
        'label' => lang('BancaHotel.banca_hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('BancaHotel.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('banca_hotel') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'banca_hotel_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('banca_hotel') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('banca_hotel/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
