...
$filterDefinitions = [
    'ref_agenzia_listini_id' => [
        'label' => lang('RefAgenziaListini.ref_agenzia_listini_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'agenzia_listini_id' => [
        'label' => lang('RefAgenziaListini.agenzia_listini_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'agenzia_listini_id',
    ],
    'agenzia_id' => [
        'label' => lang('RefAgenziaListini.agenzia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ref_agenzia_listini') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'ref_agenzia_listini_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ref_agenzia_listini') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ref_agenzia_listini/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
