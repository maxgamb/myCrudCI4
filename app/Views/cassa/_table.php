        ...
        <div class="table-responsive">
            <table class="table table-sm table-striped table-hover align-middle text-nowrap mb-0 crud-table">
                <thead class="table-light">
                    <tr>
                        <?php
                        $nextDirection = ($sort ?? '') === 'cassa_id' && ($direction ?? 'desc') === 'asc' ? 'desc' : 'asc';
                        ...
                        <th>
                            ...
                            >
                                <?= esc(lang('Cassa.cassa_id')) ?>
                                <?php if (($sort ?? '') === 'cassa_id'): ?>
                        ...
                        $nextDirection = ($sort ?? '') === 'out_conto' && ($direction ?? 'desc') === 'asc' ? 'desc' : 'asc';
                        $sortQuery = array_replace((array) ($query ?? []), [
                            'sort' => 'out_conto',
                            'direction' => $nextDirection,
                            'page' => 1,
                        ...
                        </th>                        <th><?= esc(lang('Cassa.totale_importo')) ?></th>
                        <th><?= esc(lang('Cassa.totale_modificato')) ?></th>
                        <th><?= esc(lang('Cassa.pagamento_importo_pag')) ?></th>
                        <th><?= esc(lang('Cassa.cassa_stato_camera')) ?></th>
                        <th><?= esc(lang('Cassa.nome_pagante')) ?></th>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                <td>
                                    <?php if ((string) ($row->cassa_id ?? '') !== ''): ?>
                                        <?php
                                        $quickFilters = array_values((array) ($filters ?? []));
                                        $quickFilters[] = [
                                            'field' => 'cassa_id',
                                            'operator' => 'eq',
                                            'value' => (string) $row->cassa_id,
                                            'logic' => 'and',
                                        ];
                                    ...
                                    <?php endif; ?>                                </td>                                <td>
                                    <?php if ((string) ($row->out_conto ?? '') !== ''): ?>
                                        <?php
                                        $quickFilters = array_values((array) ($filters ?? []));
                                        $quickFilters[] = [
                                            'field' => 'out_conto',
                                            'operator' => 'eq',
                                            'value' => (string) $row->out_conto,
                                            'logic' => 'and',
                                        ];
                                        $quickQuery = array_replace((array) ($query ?? []), [
                                            'filters' => $quickFilters,
                                    ...
                                    <?php if ((string) ($row->conto_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->conto_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->totale_importo ?? '') ?></td>
                                ...
                                <td class="text-end text-nowrap">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        <a href="<?= site_url('cassa/view/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-info" title="Visualizza">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?= site_url('cassa/edit/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('cassa/delete/' . rawurlencode((string) $id)) ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
