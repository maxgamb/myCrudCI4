        ...
        <div class="table-responsive">
            <table class="table table-sm table-striped table-hover align-middle text-nowrap mb-0 crud-table">
                <thead class="table-light">
                    <tr>
                        <?php
                        $nextDirection = ($sort ?? '') === 'images_id' && ($direction ?? 'desc') === 'asc' ? 'desc' : 'asc';
                        ...
                        <th>
                            ...
                            >
                                <?= esc(lang('Images.images_id')) ?>
                                <?php if (($sort ?? '') === 'images_id'): ?>
                        ...
                        </th>                        <th><?= esc(lang('Images.camera_id')) ?></th>
                        <?php
                        ...
                        </th>                        <th><?= esc(lang('Images.tipologia_id')) ?></th>
                        <th><?= esc(lang('Images.img_small')) ?></th>
                        <th><?= esc(lang('Images.img_medium')) ?></th>
                        <th><?= esc(lang('Images.img_large')) ?></th>
                        <th><?= esc(lang('Images.titolo')) ?></th>
                        <th><?= esc(lang('Images.utente_id')) ?></th>
                        ...
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <td class="text-end text-nowrap">
                                    <?php $id = $row->images_id ?? ''; ?>
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        <a href="<?= site_url('images/view/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-info" title="Visualizza">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?= site_url('images/edit/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('images/delete/' . rawurlencode((string) $id)) ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
