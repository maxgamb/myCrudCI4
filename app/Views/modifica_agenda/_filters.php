...
$filterDefinitions = [
    'mod_agenda_id' => [
        'label' => lang('ModificaAgenda.mod_agenda_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'mod_agenda_id',
    ],
    'mod_preno_id' => [
        'label' => lang('ModificaAgenda.mod_preno_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('modifica_agenda') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'mod_agenda_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('modifica_agenda') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('modifica_agenda/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
