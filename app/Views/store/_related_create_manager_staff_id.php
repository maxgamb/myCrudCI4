...
<div class="row g-3">
            <div class="col-12 col-md-6">
                <label for="related_create_manager_staff_id_first_name" class="form-label"><?= esc('First Name') ?></label>
                <input
                    type="text"
                    name="_related[manager_staff_id][first_name]"
                    id="related_create_manager_staff_id_first_name"
                    value="<?= esc((string) (($relatedPayloadState['manager_staff_id']['first_name'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['manager_staff_id__related__first_name']) ? 'is-invalid' : '' ?> crud-related-create-field"
                ...
                <label for="related_create_manager_staff_id_last_name" class="form-label"><?= esc('Last Name') ?></label>
                <input
                    type="text"
                    name="_related[manager_staff_id][last_name]"
                    id="related_create_manager_staff_id_last_name"
                    value="<?= esc((string) (($relatedPayloadState['manager_staff_id']['last_name'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['manager_staff_id__related__last_name']) ? 'is-invalid' : '' ?> crud-related-create-field"
                    data-related-field="manager_staff_id"
                    <?= $relatedCreateActive ? '' : 'disabled' ?>
                     required maxlength="45"
                >
                ...
                <label for="related_create_manager_staff_id_email" class="form-label"><?= esc('Email') ?></label>
                <input
                    type="email"
                    name="_related[manager_staff_id][email]"
                    id="related_create_manager_staff_id_email"
                    value="<?= esc((string) (($relatedPayloadState['manager_staff_id']['email'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['manager_staff_id__related__email']) ? 'is-invalid' : '' ?> crud-related-create-field"
                    data-related-field="manager_staff_id"
                    <?= $relatedCreateActive ? '' : 'disabled' ?>
                     maxlength="50"
                >
                ...
                <label for="related_create_manager_staff_id_active" class="form-label"><?= esc('Active') ?></label>
                <input
                    type="hidden"
                    name="_related[manager_staff_id][active]"
                    value="0"
                ...
                <div class="form-check">
                    <input
                        type="checkbox"
                        name="_related[manager_staff_id][active]"
                        id="related_create_manager_staff_id_active"
                        value="1"
                ...
                <label for="related_create_manager_staff_id_username" class="form-label"><?= esc('Username') ?></label>
                <input
                    type="text"
                    name="_related[manager_staff_id][username]"
                    id="related_create_manager_staff_id_username"
                    value="<?= esc((string) (($relatedPayloadState['manager_staff_id']['username'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['manager_staff_id__related__username']) ? 'is-invalid' : '' ?> crud-related-create-field"
                    data-related-field="manager_staff_id"
                    <?= $relatedCreateActive ? '' : 'disabled' ?>
                ...
                <label for="related_create_manager_staff_id_password" class="form-label"><?= esc('Password') ?></label>
                <input
                    type="text"
                    name="_related[manager_staff_id][password]"
                    id="related_create_manager_staff_id_password"
                    value="<?= esc((string) (($relatedPayloadState['manager_staff_id']['password'] ?? ''))) ?>"
                    class="form-control <?= isset($errors['manager_staff_id__related__password']) ? 'is-invalid' : '' ?> crud-related-create-field"
                    data-related-field="manager_staff_id"
                    <?= $relatedCreateActive ? '' : 'disabled' ?>
                     maxlength="40"
                >
