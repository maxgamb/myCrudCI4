...
<div class="input-group crud-relation-input-group">
                    <select
                        ...
                        id="manager_staff_id"
                        class="form-select <?= isset($errors['manager_staff_id']) ? 'is-invalid' : '' ?>"
                        aria-describedby="manager_staff_id-error"
                        aria-invalid="<?= isset($errors['manager_staff_id']) ? 'true' : 'false' ?>"
                        required
                    >
                        <option value="">Seleziona...</option>
                        <?php foreach (($options['manager_staff_id'] ?? []) as $optionValue => $optionLabel): ?>
                            <option
                                value="<?= esc($optionValue) ?>"
                                <?= (string) old('manager_staff_id', $row->{'manager_staff_id'} ?? ($context['manager_staff_id'] ?? '')) === (string) $optionValue ? 'selected' : '' ?>
                            >
                                <?= esc($optionLabel) ?>
                            </option>
                        <?php endforeach; ?>
                        ...
                        <a
                            ...
                            data-value-source="manager_staff_id"
                        ...
                        <button
                            ...
                            id="related_create_manager_staff_id_toggle"
                            data-bs-toggle="offcanvas"
                            data-bs-target="#related_create_manager_staff_id"
                            aria-controls="related_create_manager_staff_id"
                            data-related-field="manager_staff_id"
                            data-panel-target="related_create_manager_staff_id"
                            data-state-target="related_create_manager_staff_id_state"
                    ...
                    <?php if (!empty($errors['manager_staff_id'])): ?>
                        <div id="manager_staff_id-error" class="invalid-feedback d-block">
                            <?= esc($errors['manager_staff_id']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <?php if ($row === null): ?>
                    ...
                    $relatedCreateActive = !empty($relatedNewState['manager_staff_id']);
                    ?>
                    <div class="col-12">
                        <input
                            type="hidden"
                            name="_related_new[manager_staff_id]"
                            id="related_create_manager_staff_id_state"
                            value="<?= $relatedCreateActive ? '1' : '0' ?>"
                        >
                        <div
                            id="related_create_manager_staff_id"
                            class="offcanvas offcanvas-end crud-related-create-panel"
                            style="--bs-offcanvas-width: min(640px, 100vw);"
                            tabindex="-1"
                            aria-labelledby="related_create_manager_staff_id_label"
                            data-related-field="manager_staff_id"
                            data-state-target="related_create_manager_staff_id_state"
                            data-toggle-target="related_create_manager_staff_id_toggle"
                            data-bs-backdrop="static"
                        >
                            <div class="offcanvas-header border-bottom">
                                <div>
                                    <h2 class="offcanvas-title h5 mb-0" id="related_create_manager_staff_id_label">New Staff</h2>
                                    <small class="text-muted">Relation manager_staff_id</small>
                                </div>
                                <button
                                    type="button"
                            ...
                            <div class="offcanvas-body">
                                ...
                                <?= view('store/_related_create_manager_staff_id', [
                                    'relatedField'        => 'manager_staff_id',
                    ...
                    <div class="col-12">
                        ...
                        >
                            ...
                            <div class="offcanvas-body">
                                ...
                                <?= view('store/_related_create_address_id', [
