            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="ref_cookie" class="form-label">
                        <?= esc(lang('LogObmpFull.ref_cookie')) ?>
                    </label>
                    <input
                        type="text"
                        name="ref_cookie"
                ...
                <div class="col-md-6">
                    <label for="mygooglekeyword" class="form-label">
                        <?= esc(lang('LogObmpFull.mygooglekeyword')) ?>
                    </label>
                    <input
                        type="text"
                ...
                <div class="col-md-6">
                    <label for="today" class="form-label">
                        <?= esc(lang('LogObmpFull.today')) ?>
                    </label>
                    <input
                        type="date"
                        name="today"
                        id="today"
                        value="<?= esc(old('today', $row->today ?? ($context['today'] ?? ''))) ?>"
                        class="form-control <?= isset($errors['today']) ? 'is-invalid' : '' ?>"
                        aria-describedby="today-error"
                        aria-invalid="<?= isset($errors['today']) ? 'true' : 'false' ?>"
                        required
                    >
                    <?php if (!empty($errors['today'])): ?>
                        <div id="today-error" class="invalid-feedback d-block">
                            <?= esc($errors['today']) ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    <label for="log_obmp_daterecord" class="form-label">
                        <?= esc(lang('LogObmpFull.log_obmp_daterecord')) ?>
                    </label>
                    <input
                        type="datetime-local"
