...
$filterDefinitions = [
    'log_obmp_id_full' => [
        'label' => lang('LogObmpFull.log_obmp_id_full'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'preno_dal' => [
        'label' => lang('LogObmpFull.preno_dal'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'preno_al' => [
        'label' => lang('LogObmpFull.preno_al'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('LogObmpFull.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'ref_site' => [
        'label' => lang('LogObmpFull.ref_site'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'ref_agency' => [
        'label' => lang('LogObmpFull.ref_agency'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'ref_event' => [
        'label' => lang('LogObmpFull.ref_event'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'ref_session' => [
        'label' => lang('LogObmpFull.ref_session'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'ref_cookie' => [
        'label' => lang('LogObmpFull.ref_cookie'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('log_obmp_full') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'log_obmp_id_full') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('log_obmp_full') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('log_obmp_full/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
