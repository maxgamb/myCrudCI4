...
$filterDefinitions = [
    'registro_ps_id' => [
        'label' => lang('RegistroPs.registro_ps_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('registro_ps') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'registro_ps_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('registro_ps') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('registro_ps/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
