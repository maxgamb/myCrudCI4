...
<div class="input-group crud-relation-input-group">
                    ...
                    >
                        ...
                        <button
                            ...
                            title="Crea nuovo Rental"
                            aria-label="Crea nuovo Rental"
                        >
                            <i class="bi bi-plus-circle me-1" aria-hidden="true"></i>
                            Nuovo
                        </button>
                ...
                <?php if ($row === null): ?>
                    ...
                    <div class="col-12">
                        ...
                        >
                            <div class="offcanvas-header border-bottom">
                                <div>
                                    <h2 class="offcanvas-title h5 mb-0" id="related_create_rental_id_label">Nuovo Rental</h2>
                                    <small class="text-muted">Relazione rental_id</small>
                                </div>
                                <button
                                    type="button"
                                    class="btn-close crud-related-create-cancel"
                                    ...
                                    data-state-target="related_create_rental_id_state"
                                    data-bs-dismiss="offcanvas"
                                    aria-label="Annulla nuovo Rental"
                                ></button>
                            </div>
                            <div class="offcanvas-body">
                                <div class="alert alert-light border small" role="note">
                                    Compila i dati del nuovo Rental. Il record collegato e questo record verranno salvati insieme al submit del form principale, nella stessa transazione.
                                </div>
                ...
                <div class="col-md-6">
                    <label for="payment_date" class="form-label">
                        <?= esc(lang('Payment.payment_date')) ?>
                    </label>
                    <input
                        type="datetime-local"
                        name="payment_date"
                        id="payment_date"
                        value="<?= esc(old('payment_date', isset($row->{'payment_date'}) ? str_replace(' ', 'T', substr((string) $row->{'payment_date'}, 0, 16)) : ($context['payment_date'] ?? ''))) ?>"
                        class="form-control <?= isset($errors['payment_date']) ? 'is-invalid' : '' ?>"
                        aria-describedby="payment_date-error"
