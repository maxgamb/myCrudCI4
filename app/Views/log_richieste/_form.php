            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="log_ric_hotel_id"
                        value="<?= esc(old('log_ric_hotel_id', $row->log_ric_hotel_id ?? ($context['log_ric_hotel_id'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="log_ric_dal"
                        id="log_ric_dal"
                        value="<?= esc(old('log_ric_dal', $row->log_ric_dal ?? ($context['log_ric_dal'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="log_ric_al"
                        id="log_ric_al"
                        value="<?= esc(old('log_ric_al', $row->log_ric_al ?? ($context['log_ric_al'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="log_ric_data"
                        id="log_ric_data"
                        value="<?= esc(old('log_ric_data', $row->log_ric_data ?? ($context['log_ric_data'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="log_ric_notti"
                        id="log_ric_notti"
                        value="<?= esc(old('log_ric_notti', $row->log_ric_notti ?? ($context['log_ric_notti'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="log_ric_wind"
                        id="log_ric_wind"
                        value="<?= esc(old('log_ric_wind', $row->log_ric_wind ?? ($context['log_ric_wind'] ?? ''))) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('log_ric_utente_id', $row->log_ric_utente_id ?? ($context['log_ric_utente_id'] ?? ''))) ?>"
