...
$filterDefinitions = [
    'log_ric_id' => [
        'label' => lang('LogRichieste.log_ric_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'log_ric_hotel_id' => [
        'label' => lang('LogRichieste.log_ric_hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('log_richieste') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'log_ric_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('log_richieste') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('log_richieste/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
