...
$filterDefinitions = [
    'pratica_id' => [
        'label' => lang('Pratiche.pratica_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'pratica_agenzia_id' => [
        'label' => lang('Pratiche.pratica_agenzia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'pratica_agenzia_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('pratiche') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'pratica_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('pratiche') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('pratiche/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
