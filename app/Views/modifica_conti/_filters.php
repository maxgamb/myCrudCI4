...
$filterDefinitions = [
    'id_mod_conto' => [
        'label' => lang('ModificaConti.id_mod_conto'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'mod_conto_id' => [
        'label' => lang('ModificaConti.mod_conto_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'mod_conto_id',
    ],
    'mod_camera_id' => [
        'label' => lang('ModificaConti.mod_camera_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('modifica_conti') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'id_mod_conto') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('modifica_conti') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('modifica_conti/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
