                ...
                <thead class="table-light">
                    <tr>
                        ...
                        <th>
                            ...
                            >
                                <?= esc(lang('Prodotti.prodotto_id')) ?>
                                <?php if (($sort ?? '') === 'prodotto_id'): ?>
                                    <i class="bi bi-sort-<?= ($direction ?? 'desc') === 'asc' ? 'up' : 'down' ?>"></i>
                                <?php endif; ?>
                            </a>
                        </th>                        <th><?= esc(lang('Prodotti.prodotti_lista_id')) ?></th>
                        <?php
                        ...
                        </th>                        <th><?= esc(lang('Prodotti.nome_prodotto')) ?></th>
                        <th><?= esc(lang('Prodotti.prezzo_prodotto')) ?></th>
                        <th><?= esc(lang('Prodotti.tipologia_prodotto')) ?></th>
                        <th><?= esc(lang('Prodotti.reparto_prodotto')) ?></th>
                        <th><?= esc(lang('Prodotti.cent_costo_prodotto')) ?></th>
                        <th><?= esc(lang('Prodotti.prodotti_utente_id')) ?></th>
                            ...
                            <tr>
                                <td>
                                    <?php if ((string) ($row->prodotto_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->prodotto_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->prodotti_lista_id ?? '') ?></td>
                                <td>
                                    <?php if ((string) ($row->hotel_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->hotel_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->nome_prodotto ?? '') ?></td>
                                ...
                                <td class="text-end text-nowrap">
                                    <?php $id = $row->prodotto_id ?? ''; ?>
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        <a href="<?= site_url('prodotti/view/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-info" title="Visualizza">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?= site_url('prodotti/edit/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('prodotti/delete/' . rawurlencode((string) $id)) ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
