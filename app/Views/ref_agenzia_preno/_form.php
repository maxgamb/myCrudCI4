    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="ref_a_p_datarecord" class="form-label">
                        <?= esc(lang('RefAgenziaPreno.ref_a_p_datarecord')) ?>
                    </label>
                    <input
                        type="datetime-local"
                        name="ref_a_p_datarecord"
                        id="ref_a_p_datarecord"
                        value="<?= esc(old('ref_a_p_datarecord', isset($row->ref_a_p_datarecord) ? str_replace(' ', 'T', substr((string) $row->ref_a_p_datarecord, 0, 16)) : ($context['ref_a_p_datarecord'] ?? ''))) ?>"
                        class="form-control <?= isset($errors['ref_a_p_datarecord']) ? 'is-invalid' : '' ?>"
                        aria-describedby="ref_a_p_datarecord-error"
                        aria-invalid="<?= isset($errors['ref_a_p_datarecord']) ? 'true' : 'false' ?>"
                    >
                    <?php if (!empty($errors['ref_a_p_datarecord'])): ?>
                        <div id="ref_a_p_datarecord-error" class="invalid-feedback d-block">
                            <?= esc($errors['ref_a_p_datarecord']) ?>
                        </div>
                    <?php endif; ?>
                </div>
