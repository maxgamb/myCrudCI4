...
$filterDefinitions = [
    'punti_spesi_id' => [
        'label' => lang('PuntiSpesi.punti_spesi_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('PuntiSpesi.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'cliente_id' => [
        'label' => lang('PuntiSpesi.cliente_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'conto_id' => [
        'label' => lang('PuntiSpesi.conto_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('punti_spesi') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'punti_spesi_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('punti_spesi') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('punti_spesi/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
