...
$filterDefinitions = [
    'black_list_id' => [
        'label' => lang('BlackList.black_list_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'clienti_id' => [
        'label' => lang('BlackList.clienti_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('black_list') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'black_list_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('black_list') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('black_list/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
