...
$filterDefinitions = [
    'obmp_restriction_id' => [
        'label' => lang('ObmpRestrictions.obmp_restriction_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('obmp_restrictions') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'obmp_restriction_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('obmp_restrictions') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('obmp_restrictions/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
