            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    <label for="description" class="form-label">
                        <?= esc(lang('WrehProducts.description')) ?>
                    </label>
                    <textarea
                        name="description"
                        id="description"
                ...
                <div class="col-md-6">
                    <label for="stock_quantity" class="form-label">
                        <?= esc(lang('WrehProducts.stock_quantity')) ?>
                    </label>
                    <input
                        type="number"
                        name="stock_quantity"
                ...
                <div class="col-md-6">
                    ...
                    <select
                        name="supplier_id"
                        id="supplier_id"
                        class="form-select <?= isset($errors['supplier_id']) ? 'is-invalid' : '' ?>"
