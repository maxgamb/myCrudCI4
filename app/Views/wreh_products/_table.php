        ...
        <div class="table-responsive">
            <table class="table table-sm table-striped table-hover align-middle text-nowrap mb-0 crud-table">
                <thead class="table-light">
                    <tr>
                        <?php
                        $nextDirection = ($sort ?? '') === 'product_id' && ($direction ?? 'desc') === 'asc' ? 'desc' : 'asc';
                        ...
                        <th>
                            ...
                            >
                                <?= esc(lang('WrehProducts.product_id')) ?>
                        ...
                        <th>
                            <a
                                ...
                                data-direction="<?= esc($nextDirection) ?>"
                            >
                                <?= esc(lang('WrehProducts.costi_area_id')) ?>
                                <?php if (($sort ?? '') === 'costi_area_id'): ?>
                                    <i class="bi bi-sort-<?= ($direction ?? 'desc') === 'asc' ? 'up' : 'down' ?>"></i>
                                <?php endif; ?>
                            </a>
                        </th>                        <th><?= esc(lang('WrehProducts.name')) ?></th>
                        <th><?= esc(lang('WrehProducts.price')) ?></th>
                        <th><?= esc(lang('WrehProducts.stock_quantity')) ?></th>
                        <?php
                        ...
                        <th>
                            <a
                                ...
                                data-direction="<?= esc($nextDirection) ?>"
                            >
                                <?= esc(lang('WrehProducts.supplier_id')) ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        ...
                                        <a href="<?= site_url('wreh_products/edit/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('wreh_products/delete/' . rawurlencode((string) $id)) ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
