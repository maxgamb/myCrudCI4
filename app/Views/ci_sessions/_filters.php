...
$filterDefinitions = [
  ...
  6 => 'not_null',
    ...
    'timestamp' => [
        'label' => lang('CiSessions.timestamp'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('ci_sessions') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('ci_sessions') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('ci_sessions/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
