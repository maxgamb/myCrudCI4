...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'numero_camera' => [
        'label' => lang('Camere.numero_camera'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'tipologia_id' => [
        'label' => lang('Camere.tipologia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('camere') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'camera_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('camere') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('camere/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
