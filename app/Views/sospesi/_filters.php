...
$filterDefinitions = [
  ...
  8 => 'not_null',
    ...
    'pagamento_id' => [
        'label' => lang('Sospesi.pagamento_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'sospeso_data' => [
        'label' => lang('Sospesi.sospeso_data'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'sospeso_conto_id' => [
        'label' => lang('Sospesi.sospeso_conto_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'sospeso_pratica_id' => [
        'label' => lang('Sospesi.sospeso_pratica_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'sospeso_pratica_id',
    ],
    'sopeso_societa' => [
        'label' => lang('Sospesi.sopeso_societa'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'sopeso_societa',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('sospesi') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'sospeso_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('sospesi') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('sospesi/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
