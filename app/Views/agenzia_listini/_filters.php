...
$filterDefinitions = [
    'agenzia_listini_id' => [
        'label' => lang('AgenziaListini.agenzia_listini_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('AgenziaListini.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
<form id="crudFiltersForm" method="get" action="<?= site_url('agenzia_listini') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'agenzia_listini_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('agenzia_listini') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('agenzia_listini/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
