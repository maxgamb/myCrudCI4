                ...
                <thead class="table-light">
                    <tr>
                        ...
                        <th>
                            ...
                            >
                                <?= esc(lang('AgenziaListini.agenzia_listini_id')) ?>
                        ...
                        </th>                        <th><?= esc(lang('AgenziaListini.agenzia_listini_nome')) ?></th>
                        <th><?= esc(lang('AgenziaListini.agenzia_listini_note')) ?></th>
                        <th><?= esc(lang('AgenziaListini.agenzia_listini_datarecord')) ?></th>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ((string) ($row->hotel_id ?? '') !== ''): ?>
                                        ...
                                        ><?= esc($row->hotel_id) ?></a>
                                    <?php endif; ?>
                                </td>                                <td><?= esc($row->agenzia_listini_nome ?? '') ?></td>
                                <td><?= esc($row->agenzia_listini_note ?? '') ?></td>
                                <td><?= esc($row->agenzia_listini_datarecord ?? '') ?></td>
                                <td class="text-end text-nowrap">
                                    <?php $id = $row->agenzia_listini_id ?? ''; ?>
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Azioni record">
                                        <a href="<?= site_url('agenzia_listini/view/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-info" title="Visualizza">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="<?= site_url('agenzia_listini/edit/' . rawurlencode((string) $id)) ?>" class="btn btn-outline-warning" title="Modifica">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="post" action="<?= site_url('agenzia_listini/delete/' . rawurlencode((string) $id)) ?>" class="d-inline" onsubmit="return confirm('Eliminare questo record?')">
                                            <?= csrf_field() ?>
