...
$filterDefinitions = [
  ...
  6 => 'not_null',
    ...
    'language_id' => [
        'label' => lang('Film.language_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'language_id',
    ],
    'original_language_id' => [
        'label' => lang('Film.original_language_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'original_language_id',
    ],
];
...
<form id="crudFiltersForm" method="get" action="<?= site_url('film') ?>">
    <input type="hidden" name="sort" value="<?= esc($sort ?? 'film_id') ?>">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-auto">
            ...
            <a href="<?= site_url('film') ?>" class="btn btn-outline-secondary js-reset-filters">
                Azzera
            </a>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('film/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
