...
$filterDefinitions = [
    'foglio_id' => [
        'label' => lang('FoglioGiorno.foglio_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'hotel_id' => [
        'label' => lang('FoglioGiorno.hotel_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'conto_id' => [
        'label' => lang('FoglioGiorno.conto_id'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'camera_id' => [
        'label' => lang('FoglioGiorno.camera_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'preno_id' => [
        'label' => lang('FoglioGiorno.preno_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
    ...
    'tipologia_id' => [
        'label' => lang('FoglioGiorno.tipologia_id'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
),
        'relation' => 'tipologia_id',
    ],
    'foglio_prezzo_camera' => [
        'label' => lang('FoglioGiorno.foglio_prezzo_camera'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'date_foglio' => [
        'label' => lang('FoglioGiorno.date_foglio'),
        'input' => 'text',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  6 => 'not_null',
    ...
    'in_conto' => [
        'label' => lang('FoglioGiorno.in_conto'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'out_preno' => [
        'label' => lang('FoglioGiorno.out_preno'),
        'input' => 'date',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'stato_camera' => [
        'label' => lang('FoglioGiorno.stato_camera'),
        'input' => 'number',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
  ...
  8 => 'not_null',
    ...
    'preno_agenzia' => [
        'label' => lang('FoglioGiorno.preno_agenzia'),
        'input' => 'select',
        'operators' => array (
  0 => 'eq',
  1 => 'neq',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const relationBaseUrl = <?= json_encode(site_url('foglio_giorno/relation-options'), JSON_UNESCAPED_SLASHES) ?>;
