            ...
            <?= form_open($formAction, [
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="nome_hotel"
                        id="nome_hotel"
                        value="<?= esc(old('nome_hotel', $row->nome_hotel ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotel_tipologia"
                        value="<?= esc(old('hotel_tipologia', $row->hotel_tipologia ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotel_categoria"
                        value="<?= esc(old('hotel_categoria', $row->hotel_categoria ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_citta"
                        id="hotel_citta"
                        value="<?= esc(old('hotel_citta', $row->hotel_citta ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_via"
                        id="hotel_via"
                        value="<?= esc(old('hotel_via', $row->hotel_via ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_tel"
                        id="hotel_tel"
                        value="<?= esc(old('hotel_tel', $row->hotel_tel ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_fax"
                        id="hotel_fax"
                        value="<?= esc(old('hotel_fax', $row->hotel_fax ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_email"
                        id="hotel_email"
                        value="<?= esc(old('hotel_email', $row->hotel_email ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_stato"
                        id="hotel_stato"
                        value="<?= esc(old('hotel_stato', $row->hotel_stato ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_cap"
                        id="hotel_cap"
                        value="<?= esc(old('hotel_cap', $row->hotel_cap ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_piva"
                        id="hotel_piva"
                        value="<?= esc(old('hotel_piva', $row->hotel_piva ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_numero_camere', $row->hotel_numero_camere ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotels_utente_id"
                        value="<?= esc(old('hotels_utente_id', $row->hotels_utente_id ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_web"
                        id="hotel_web"
                        value="<?= esc(old('hotel_web', $row->hotel_web ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_logo"
                        id="hotel_logo"
                        value="<?= esc(old('hotel_logo', $row->hotel_logo ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_mappa"
                        id="hotel_mappa"
                        value="<?= esc(old('hotel_mappa', $row->hotel_mappa ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_reach_by_car', $row->hotel_reach_by_car ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_reach_by_treno', $row->hotel_reach_by_treno ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_reach_aereo', $row->hotel_reach_aereo ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotel_reach_nave"
                        value="<?= esc(old('hotel_reach_nave', $row->hotel_reach_nave ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_foto_piccola', $row->hotel_foto_piccola ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_foto_grande', $row->hotel_foto_grande ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_testo_en"
                        id="hotel_testo_en"
                        value="<?= esc(old('hotel_testo_en', $row->hotel_testo_en ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_testo_it"
                        id="hotel_testo_it"
                        value="<?= esc(old('hotel_testo_it', $row->hotel_testo_it ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotel_disp_modo"
                        value="<?= esc(old('hotel_disp_modo', $row->hotel_disp_modo ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_limite_vendite_web', $row->hotel_limite_vendite_web ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_limite_vendite_xml', $row->hotel_limite_vendite_xml ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_incremento_prezzo_xml', $row->hotel_incremento_prezzo_xml ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_booking_attivazione', $row->hotel_booking_attivazione ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_booking_url', $row->hotel_booking_url ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_booking_agenzia', $row->hotel_booking_agenzia ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_tarif_cambia_gg', $row->hotel_tarif_cambia_gg ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_tarif_listino_nome_id', $row->hotel_tarif_listino_nome_id ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_agenzia_attivazione', $row->hotel_agenzia_attivazione ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_type_booking', $row->hotel_type_booking ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="hotel_check_in"
                        id="hotel_check_in"
                        value="<?= esc(old('hotel_check_in', $row->hotel_check_in ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotel_check_out"
                        value="<?= esc(old('hotel_check_out', $row->hotel_check_out ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('hotel_serv_inclusi', $row->hotel_serv_inclusi ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        id="hotel_cancel_pol"
                        value="<?= esc(old('hotel_cancel_pol', $row->hotel_cancel_pol ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="facebook"
                        id="facebook"
                        value="<?= esc(old('facebook', $row->facebook ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="google"
                        id="google"
                        value="<?= esc(old('google', $row->google ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="instagram"
                        id="instagram"
                        value="<?= esc(old('instagram', $row->instagram ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="twitter"
                        id="twitter"
                        value="<?= esc(old('twitter', $row->twitter ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="linkedin"
                        id="linkedin"
                        value="<?= esc(old('linkedin', $row->linkedin ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="analytics"
                        id="analytics"
                        value="<?= esc(old('analytics', $row->analytics ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="email_desk"
                        id="email_desk"
                        value="<?= esc(old('email_desk', $row->email_desk ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="tripadvisor"
                        id="tripadvisor"
                        value="<?= esc(old('tripadvisor', $row->tripadvisor ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="trip_rec_url"
                        id="trip_rec_url"
                        value="<?= esc(old('trip_rec_url', $row->trip_rec_url ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="ae_user"
                        id="ae_user"
                        value="<?= esc(old('ae_user', $row->ae_user ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="ae_password"
                        id="ae_password"
                        value="<?= esc(old('ae_password', $row->ae_password ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="ae_pin"
                        id="ae_pin"
                        value="<?= esc(old('ae_pin', $row->ae_pin ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="<?= esc(old('ae_codice_fiscale', $row->ae_codice_fiscale ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="sa_nome"
                        id="sa_nome"
                        value="<?= esc(old('sa_nome', $row->sa_nome ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="sa_chiave"
                        id="sa_chiave"
                        value="<?= esc(old('sa_chiave', $row->sa_chiave ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="ae_test"
                        id="ae_test"
                        value="<?= esc(old('ae_test', $row->ae_test ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="wifi_network"
                        id="wifi_network"
                        value="<?= esc(old('wifi_network', $row->wifi_network ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="wifi_password"
                        id="wifi_password"
                        value="<?= esc(old('wifi_password', $row->wifi_password ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="chek_email"
                        id="chek_email"
                        value="<?= esc(old('chek_email', $row->chek_email ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="chek_tel"
                        id="chek_tel"
                        value="<?= esc(old('chek_tel', $row->chek_tel ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="nexi_alias"
                        id="nexi_alias"
                        value="<?= esc(old('nexi_alias', $row->nexi_alias ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="nexi_key"
                        id="nexi_key"
                        value="<?= esc(old('nexi_key', $row->nexi_key ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="nexi_url"
                        id="nexi_url"
                        value="<?= esc(old('nexi_url', $row->nexi_url ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="cir_bdsr"
                        id="cir_bdsr"
                        value="<?= esc(old('cir_bdsr', $row->cir_bdsr ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="cin_bdsr"
                        id="cin_bdsr"
                        value="<?= esc(old('cin_bdsr', $row->cin_bdsr ?? '')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="catastale_id"
                        id="catastale_id"
                        value="<?= esc(old('catastale_id', $row->catastale_id ?? '')) ?>"
